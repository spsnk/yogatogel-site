...
!(function (e) {
  function t(e, t, i, o, n, r, a, s) {
    function c() {
      return (
        (!_.includes(window.location.host, "localhost") ? "https" : "http") +
        "://" +
        a.webApi.host +
        "/api/v1"
      )
      ...
      t.addEventListener("load", function () {
        t.cookieconsent &&
          t.cookieconsent.initialise({
            ...
            content: {
              href:
                "https://www.quickdatabasediagrams.com/privacy-and-security.html",
            },
            cookie: {
  ...
  ;(t.$inject = [
    ...
    angular
      .module("QdbdApp", [
        ...
        "angular-loading-bar",
        "QdbdApp.Common",
        "QdbdApp.MessageScreen",
        "QdbdApp.Home",
        "QdbdApp.Schema",
        "QdbdApp.Login",
        "QdbdApp.Register",
        "QdbdApp.User",
        "QdbdApp.Subscription",
        "QdbdApp.Admin",
        "QdbdApp.Voucher",
        "QdbdApp.Collaborators",
      ])
      .config(t)
      .run(i)
})(QdbdApp || (QdbdApp = {}))
...
!(function (e) {
  e.Component = function (e, t, i) {
    return function (o) {
      ;("string" == typeof e ? angular.module(e) : e).component(
        t,
        angular.extend(i, {
          controller: o,
        })
...
var QdbdApp
QdbdApp || (QdbdApp = {}), angular.module("QdbdApp.Common", [])
var QdbdApp
QdbdApp || (QdbdApp = {}),
  angular.module("QdbdApp.Admin", []).config([
    "$stateProvider",
    function (e) {
      e.state("root.standard.admin", {
        ...
        .state("root.standard.admin.userList", {
          ...
          views: {
            "admin-content": {
              template:
                "<dt-user-list filter='AdminVM.usersFilter'></dt-user-list>",
            },
          },
          data: {
        ...
        .state("root.standard.admin.diagramList", {
          ...
          views: {
            "admin-content": {
              template:
                "<dt-schema-list filter='AdminVM.schemasFilter'></dt-schema-list>",
            },
          },
          data: {
        ...
        .state("root.standard.admin.vouchersList", {
          ...
          views: {
            "admin-content": {
              template:
                "<dt-voucher-list filter='AdminVM.voucherFilter'></dt-voucher-list>",
            },
          },
          data: {
...
var QdbdApp
QdbdApp || (QdbdApp = {}), angular.module("QdbdApp.Collaborators", [])
var QdbdApp
QdbdApp || (QdbdApp = {}), angular.module("QdbdApp.DiagramRenderer", [])
var QdbdApp
QdbdApp || (QdbdApp = {}),
  angular
    .module("QdbdApp.Home", [
      "QdbdApp.SourceEditor",
      "QdbdApp.SchemaDir",
      "QdbdApp.DiagramRenderer",
    ])
    .config([
      "$stateProvider",
      function (e) {
...
var QdbdApp
QdbdApp || (QdbdApp = {}),
  angular.module("QdbdApp.Login", []).config([
    "$stateProvider",
    function (e) {
...
var QdbdApp
QdbdApp || (QdbdApp = {}),
  angular.module("QdbdApp.MessageScreen", []).config([
    "$stateProvider",
    function (e) {
...
var QdbdApp
QdbdApp || (QdbdApp = {}),
  angular.module("QdbdApp.Register", []).config([
    "$stateProvider",
    function (e) {
...
var QdbdApp
QdbdApp || (QdbdApp = {}), angular.module("QdbdApp.SchemaDir", [])
var QdbdApp
QdbdApp || (QdbdApp = {}), angular.module("QdbdApp.Schema", [])
var QdbdApp
QdbdApp || (QdbdApp = {}), angular.module("QdbdApp.SourceEditor", [])
var QdbdApp
QdbdApp || (QdbdApp = {}),
  angular.module("QdbdApp.Subscription", []).config([
    "$stateProvider",
    function (e) {
...
var QdbdApp
QdbdApp || (QdbdApp = {}),
  angular.module("QdbdApp.User", []).config([
    "$stateProvider",
    function (e) {
      e.state("root.standard.user", {
        ...
        .state("root.standard.user.diagrams", {
          url:
            "/:userId/diagrams?page&pageSize&ownerId&sortBy&search&sortOperator",
          views: {
            "user-content": {
              template:
                "<dt-user-diagrams filter='UserVM.filter'></dt-user-diagrams>",
            },
          },
          data: {
            title: "Diagrams",
        ...
        .state("root.standard.user.payments", {
          ...
          views: {
            "user-content": {
              template:
                "<dt-user-payments user-id='UserVM.userId'></dt-user-payments>",
            },
          },
          data: {
            title: "Payments",
...
var QdbdApp
QdbdApp || (QdbdApp = {}), angular.module("QdbdApp.Voucher", [])
var QdbdApp
!(function (e) {
  !(function () {
    function t(e, t, i) {
    ...
    ;(t.$inject = ["$mdDialog", "SidenavService", "TrackingService"]),
      ...
      (t.prototype.loadDocsSection = function (e) {
        this.trackDocumentation(e), (this.docsSection = e)
      }),
      ...
      (t.prototype.flipSupportChat = function () {
        this.TrackingService.flipSupportChat(), this.closeSidebar()
      }),
      (t = __decorate(
        [
          e.Component("QdbdApp.Common", "dtDocs", {
...
!(function (e) {
  !(function () {
    ...
    ;(t.$inject = ["$rootScope", "AccountService", "TrackingService"]),
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.Common", "dtHeader", {
...
!(function (e) {
  !(function () {
    ...
    ;(t.$inject = ["$mdDialog"]),
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.Common", "dtLoginRequired", {
            templateUrl:
              "cache/common/components/dt-login-required/dt-login-required.html",
...
!(function (e) {
  !(function () {
    ...
    t = __decorate(
      [
        e.Component("QdbdApp.Common", "dtNoItems", {
          bindings: {
            collection: "=",
          },
          template:
...
!(function (e) {
  !(function () {
    ...
    t = __decorate(
      [
        e.Component("QdbdApp.Common", "dtPager", {
          bindings: {
            filter: "=",
            collection: "=",
            pager: "=",
  ...
  !(function () {
    ...
    ;(t.$inject = [
      ...
      (t.prototype.resolveButtonVisibility = function () {
        ...
        var e = [
          "root.standardShrinkable.home",
          "root.standardShrinkable.diagram",
        ]
        this.toolbarVisibility.isDiagramRoute = this.RoutingService.stateIncludes(
          e
        )
      }),
      (t.prototype.flipSupportChat = function () {
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.Common", "dtSideToolbar", {
            templateUrl:
              "cache/common/components/dt-side-toolbar/dt-side-toolbar.html",
...
!(function (e) {
  !(function () {
    ...
    t = __decorate(
      [
        e.Component("QdbdApp.Common", "dtSortableHeading", {
          bindings: {
            filter: "=",
            pager: "=",
            name: "@",
          ...
          templateUrl:
            "cache/common/components/dt-sortable-heading/dt-sortable-heading.html",
...
!(function (e) {
  !(function () {
    function t(e, t) {
      ;(this.$mdDialog = e), (this.$state = t)
    }
    ;(t.$inject = ["$mdDialog", "$state"]),
      (t.prototype.subscribe = function () {
        this.$state.go("root.centered.subscribe"), this.closeDialog()
      }),
      (t.prototype.closeDialog = function () {
        this.$mdDialog.cancel()
      }),
      (t = __decorate(
        [
          e.Component("QdbdApp.Common", "dtSubscriptionRequired", {
            bindings: {
              customMessage: "@",
            },
            templateUrl:
              "cache/common/components/dt-subscription-required/dt-subscription-required.html",
...
!(function (e) {
  !(function () {
    function t(e) {
      ;(this.$scope = e), this.registerWatcher()
    }
    ;(t.$inject = ["$scope"]),
      (t.prototype.registerWatcher = function () {
        this.$scope.$watch(
          "DtValidationSummaryVM.model.modelState",
          this.initializeValidationSummary.bind(this)
        )
      }),
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.Common", "dtValidationSummary", {
            bindings: {
              model: "=",
            },
            templateUrl:
              "cache/common/components/dt-validation-summary/dt-validation-summary.html",
      ...
      Object.defineProperty(e, "Default", {
        get: function () {
          return {
            sharing: {
              defaultImage:
                "https://www.quickdatabasediagrams.com/assets/images/logo.svg",
              providers: {
        ...
        get: function () {
          return {
            ...
            socialAuth: {
              google: {
                clientId:
                  "979186999325-dldbn1cko23gfl33m08bfh9l0h7t3a0j.apps.googleusercontent.com",
              },
              twitter: {
...
!(function (e) {
  ...
  var i = (function () {
    function e(e, t, i) {
      ;(this.$scope = e),
        ...
        (this.modelStatePropertyName = this.ModelStateService.getModelStatePropertyName(
          e
        ))
      ...
      ;(this.$scope.validationMessage = ""),
        ...
        this.$scope.$watch(
          "model.modelState",
          this.onModelStateChanged.bind(this)
        ),
        this.$scope.$watch(
          "rootModel.modelState",
          this.onModelStateChanged.bind(this)
        )
    }
    return (
      (e.$inject = ["$scope", "AccountService", "ModelStateService"]),
      (e.prototype.onWatchedItemChanged = function (e, t, i) {
        e !== t &&
          (e || t) &&
          (this.ModelStateService.resetPropertyModelState(
            this.modelStatePropertyName,
            this.getModelState()
          ),
          (this.$scope.validationMessage = ""))
      }),
      ...
      (e.prototype.onModelStateChanged = function () {
        this.$scope.validationMessage = this.ModelStateService.findModelStateMessage(
          this.modelStatePropertyName,
          this.getModelState()
        )
      }),
      (e.prototype.getModelState = function () {
        return this.$scope.rootModel
          ? this.$scope.rootModel.modelState
          : this.$scope.model.modelState
      }),
      e
    )
  })()
  ...
  var o = (function (e) {
    ...
    return (
      ...
      (t.prototype.onWatchedItemChanged = function (t, i) {
        t !== i &&
          (t || i) &&
          (e.prototype.onWatchedItemChanged.call(this, t, i, void 0),
          (this.$scope.passwordValidation = this.AccountService.validatePassword(
            t
          )))
      }),
  ...
  ;(e.DtInputPasswordCtrl = o),
    angular
      .module("QdbdApp.Common")
      .directive("dtInputText", function () {
        return t({
          templateUrl:
            "cache/common/directives/dt-form-elements/dt-input-text.html",
        })
      })
      .directive("dtInputTextI", function () {
        return t({
          templateUrl:
            "cache/common/directives/dt-form-elements/dt-input-text-i.html",
        })
      })
      .directive("dtInputTextarea", function () {
        return t({
          templateUrl:
            "cache/common/directives/dt-form-elements/dt-input-textarea.html",
        })
      })
      .directive("dtInputPassword", function () {
        return t(
          {
            templateUrl:
              "cache/common/directives/dt-form-elements/dt-input-password.html",
          },
          o
        )
      })
        ...
        return {
          ...
          link: function (e, t, i, o) {
            t.on("keydown", function (e) {
              return !(
                [110, 190].indexOf(e.which) > -1 && (e.preventDefault(), 1)
              )
            })
          },
        }
...
!(function (e) {
  var t = (function () {
    function t() {}
    return (
      (t.prototype.getModelStatePropertyName = function (e) {
        var t = ["model"]
        if (e.collectionName) {
          var i =
            this.capitalizeFirstLetter(e.collectionName) +
            "[" +
            e.model.id +
            "]"
          t.push(i)
      ...
      (t.prototype.findModelStateKey = function (e, t) {
        for (var i in t) if (i && i.indexOf(e) > -1) return i
        return ""
      }),
    ...
    return (
      ...
      (t.prototype.reAuthenticate = function () {
        ...
        return this.$http.get("api/v1/account/refreshToken").then(function (t) {
          return e.$auth.setToken(t.data.access_token), e.resolveCurrentUser()
        })
      }),
      ...
      (t.prototype.socialAuth = function (e) {
        ...
        this.clearLocalStorageData(),
          this.$auth.authenticate(e).then(function () {
            t.resolveCurrentUser().then(
              function (e) {
                t.ToastService.showInfo("You are now logged in."),
                  t.$state.go("root.standardShrinkable.home")
              },
              function (e) {
                "Email setup required" === e.data &&
                  t.$state.go("root.centered.setEmail")
              }
            )
          })
      }),
      ...
      (t.prototype.registerAccount = function (e) {
        var t = this
        this.clearLocalStorageData(),
          this.validatePassword(e.password).isValid &&
            ((e.confirmPassword = e.password),
            this.BaseHttpService.post(
              "api/v1/account/register",
              e,
              function (e) {
                t.$auth.setToken(e.data.access_token),
                  t.resolveCurrentUser(),
                  t.ToastService.showInfo(
      ...
      (t.prototype.resolveCurrentUser = function () {
        var e = this,
          t = this.$q.defer()
        return !this.$auth.isAuthenticated() && this.$rootScope.currentUser
          ? ((this.$rootScope.currentUser = void 0),
            this.$rootScope.$broadcast("current-user-changed"),
            t.resolve(),
            t.promise)
          : (this.$http.get("api/v1/account/userInfo").then(
              function (i) {
      ...
      (t.prototype.resetPassword = function (e) {
        ...
        return this.BaseHttpService.post(
          ...
          e,
          function (e) {
            t.$auth.setToken(e.data.access_token), t.resolveCurrentUser()
          }
        )
      }),
      ...
      (t.prototype.isUserLoggedIn = function () {
        return (
          ...
          !_.isEmpty(this.$rootScope.currentUser)
        )
      }),
      (t.prototype.validatePassword = function (e) {
        ...
        return (t.isValid = !_.includes(_.values(t), !1)), t
      }),
      ...
      (t.prototype.requireSubscription = function (e) {
        return (
          !!this.requireLogin() ||
          (!this.$rootScope.currentUser.hasProAccess &&
            (e || (e = ""),
            this.$mdDialog.show({
              template:
                "\n          <md-dialog aria-label='Pro Access Required' class='modal-dialog action-required'>\n            <dt-subscription-required custom-message='" +
                e +
                "'></dt-subscription-required>\n          </md-dialog>\n        ",
              parent: angular.element(document.body),
              clickOutsideToClose: !0,
            }),
            !0))
  ...
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.diagramFactory = function () {
        ...
        return (
          (this.currentDiagram && this.currentDiagram.shortcode === e) ||
            (this.currentDiagram = {
              shortcode: e,
            }),
          this.currentDiagram
    ...
    return (
      ...
      (t.prototype.initializeTour = function () {
        ...
        this.isTourSeen() ||
          this.$timeout(function () {
            ...
            $(window).width() < 600
              ? e.createSmallScreenTour(t)
              : e.createDefaultTour(t),
              t.on("complete", function () {
                angular
                  .element(".tour-overlay-container")
                  .removeClass("visible"),
                  angular
                    .element(".tour-overlay")
                    .removeClass("active visible"),
                  e.markTourAsSeen()
              }),
              t.start()
          })
      ...
      (t.prototype.createSmallScreenTour = function (e) {
        e.addStep("Welcome", {
          ...
          text:
            "We're glad you're interested in our app but you're seeing only a very limited functionality because you are viewing it on a small screen.For full experience please view it on a bigger screen.",
...
!(function (e) {
  var t = (function () {
    function t(e) {
      ;(this.DialogService = e), this.initialize()
    }
    return (
      (t.$inject = ["DialogService"]),
      ...
      (t = __decorate(
        [e.Service("QdbdApp.Common", "BrowserSupportService")],
        t
      ))
    )
  })()
...
!(function (e) {
  var t = (function () {
    function t() {}
    return (
      (t.prototype.getUniqHash = function (e) {
        var t, i, o, n, r, a, s, c
        for (
          t = 3 & e.length,
            i = e.length - t,
...
!(function (e) {
  var t = (function () {
    ...
    return (
      (t.$inject = ["$mdDialog", "$window", "$document"]),
      ...
      (t.prototype.onFocusChange = function () {
        ...
        !document.hidden &&
          ...
          ((e = this.onVisibilityChange).fn.apply(
            e,
            this.onVisibilityChange.params
          ),
...
!(function (e) {
    ...
    function e(e, t, i, o) {
      ...
      ;(this.$rootScope = e),
        ...
        (this.request = function (e) {
          return (
            (e.headers = e.headers || {}),
            _.startsWith(e.url, "api")
              ? (e.url = "//" + n.AppConfig.webApi.host + "/" + e.url)
              : (e.headers.Authorization = void 0),
            e || n.$q.when(e)
          )
        }),
        (this.responseError = function (e) {
          return (
            0 === e.status &&
              n.$rootScope.$broadcast("error-message", {
                header: "Unable to use the Internet connection",
                message:
                  "The webpage can't load any data because your computer isn?t connected to the Internet.",
              }),
            401 !== e.status || n.isUserInfoUrl(e)
              ? 404 === e.status
                ? n.$rootScope.$broadcast("error-message", {
                ...
                ? e.data instanceof ArrayBuffer ||
                  n.$rootScope.$broadcast(
                    "toast-error",
                    e.data || "An unknown error occured"
                  )
                : 403 === e.status ||
                  422 === e.status ||
                  (e.data &&
                    ...
                    (e.data.exceptionMessage
                      ...
                      : e.data.message &&
                        n.$rootScope.$broadcast("toast-error", e.data.message)))
              : n.$rootScope.$broadcast("unauthorized-request", e),
            n.$q.reject(e)
          )
        })
    }
    return (
      (e.Factory = function (t, i, o, n) {
  ...
  ;(e.HttpRequestInterceptor = t),
    angular
      .module("QdbdApp.Common")
      .factory("httpRequestInterceptorFactory", t.Factory)
})(QdbdApp || (QdbdApp = {}))
var QdbdApp
!(function (e) {
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.sort = function (e, t) {
        t.sortBy && t.sortBy === e
          ? (t.sortOperator =
              "descending" === t.sortOperator ? "ascending" : "descending")
          : ((t.sortBy = e), (t.sortOperator = "ascending"))
      }),
      ...
      (t.prototype.prev = function (e) {
        e.page || (e.page = 1), e.page--, e.page < 1 && (e.page = 1)
      }),
...
!(function (e) {
  var t = (function () {
    function t(e, t, i) {
      ;(this.$timeout = e), (this.$state = t), (this.AccountService = i)
    }
    return (
      (t.$inject = ["$timeout", "$state", "AccountService"]),
      (t.prototype.handleAuthRedirects = function () {
        var e = this
        this.$timeout(function () {
          var t = e.$state.$current.data
          t &&
            !0 === t.isAnonymousOnlyRoute &&
            e.AccountService.isUserLoggedIn() &&
            e.$state.go("root.standardShrinkable.home")
        })
      }),
      (t.prototype.stateIncludes = function (e) {
        var t = this
        if (_.isString(e)) return this.$state.includes(e)
        if (_.isArray(e)) {
  ...
  var t = (function () {
    function t(e, t, i, o, n) {
      ;(this.$state = e),
        ...
        (this.landingTitleText =
          "Check out QuickDBD database diagramming tool! "),
        (this.landingTitleTextTwitter =
          "Check out @quick_dbd database diagramming tool! "),
    ...
    return (
      ...
      (t.prototype.share = function (e) {
        this.TrackingService.trackShare(
          "get_link" === e ? "LINK" : e.toUpperCase()
        ),
          this.isDiagramState()
            ? this.shareUrl(this.$location.absUrl(), e)
            : this.shareUrl("https://www.quickdatabasediagrams.com/", e)
      }),
      ...
      (t.prototype.getTwitterShareLink = function (e, t) {
        return (
          this.AppConfigShared.sharing.providers.twitter +
          encodeURIComponent(t + e)
        )
      }),
      (t.prototype.getGoogleShareLink = function (e) {
        return (
          this.AppConfigShared.sharing.providers.google + encodeURIComponent(e)
        )
      }),
      (t.prototype.getLinkedinShareLink = function (e, t, i) {
        return (
          this.AppConfigShared.sharing.providers.linkedin +
          encodeURIComponent(e) +
          "&title=" +
          encodeURIComponent(t) +
          "&summary=" +
          encodeURIComponent(i) +
          "&source=app.quickdatabasediagrams.com"
        )
      }),
      (t.prototype.shareLink = function (e) {
        var t = this.$window.screenLeft,
          ...
          o =
            "width=600,height=600,resizable=yes,menubar=no,toolbar=no,scrollbars=yes,left=" +
  ...
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.onSuccess = function (e) {
        var t = e.headers(),
          i = t["x-filename"]
            ? decodeURIComponent(escape(t["x-filename"]))
            : "download",
      ...
      (t.prototype.handleException = function (e) {
        this.ToastService.showWarning(
          "Blob download not supported by your browser, please try in Chrome"
        ),
          this.$log.error(e)
      }),
      (t = __decorate(
        [e.Service("QdbdApp.Common", "StreamDownloadService")],
        t
      ))
    )
  })()
...
!(function (e) {
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.flipSupportChat = function () {
        ;(this.isChatEnabled = !this.isChatEnabled), this.restartIntercom()
      }),
      ...
      (t.prototype.restartIntercom = function () {
        this.$window.Intercom &&
          (this.$window.Intercom("shutdown"), this.initializeIntercom())
      }),
      (t.prototype.updateUser = function (e) {
        if (this.$window.Intercom) {
          ...
          this.$window.Intercom("update", {
            ...
            mx_toolbox:
              "https://mxtoolbox.com/SuperTool.aspx?action=ptr%3a" +
              e.ipAddress +
              "&run=toolpage",
            profile_url: this.$state.href(
              "root.standard.user.profile",
              {
                userId: e.userId,
              },
              {
      ...
      (t.prototype.onRouteChange = function () {
        this.$window.gtag &&
          this.$window.gtag("config", this.$window.GA_TRACKING_ID, {
      ...
      (t.prototype.trackEvent = function (e, t, i, o, n, r) {
        this.$window.gtag &&
          ...
          r &&
            this.$window.Intercom &&
            this.$window.Intercom("trackEvent", _.snakeCase(e), r)
      }),
      ...
      (t.prototype.profitWellTrack = function () {
        ...
        this.$rootScope.currentUser &&
          this.$rootScope.currentUser.email &&
          (e.pw_user_email = this.$rootScope.currentUser.email),
  ...
  !(function () {
    ...
    ;(t.$inject = ["$state", "$timeout"]),
      ...
      (t.prototype.handleRouting = function () {
        this.$state.is("root.standard.admin") &&
          this.$state.go("root.standard.admin.userList")
      }),
      ...
      (t.prototype.loadRoute = function (e) {
        var t =
          "root.standard.admin.userList" === e
            ? this.usersFilter
            : "root.standard.admin.vouchersList" === e
            ? this.voucherFilter
            : this.schemasFilter
        this.$state.go(e, t)
      }),
...
!(function (e) {
  var t = (function () {
    function t(e, t, i) {
      ;(this.$http = e), (this.$mdDialog = t), (this.BaseHttpService = i)
    }
    return (
      (t.$inject = ["$http", "$mdDialog", "BaseHttpService"]),
      (t.prototype.getCollaborators = function (e, t) {
        return "file" === t
          ? this.getDiagramCollaborators(e)
          : this.getDirectoryCollaborators(e)
      }),
      ...
      (t.prototype.createCollaborator = function (e, t) {
        return "file" === t
          ? this.createDiagramCollaborator(e)
          : this.createDirectoryCollaborator(e)
      }),
      ...
      (t.prototype.removeCollaborator = function (e) {
        return e.shortcode
          ? this.removeDiagramCollaborator(e)
          : this.removeDirectoryCollaborator(e)
      }),
      ...
      (t = __decorate(
        [e.Service("QdbdApp.Collaborators", "CollaboratorsService")],
        t
      ))
    )
  })()
  ...
  !(function () {
    ...
    ;(t.$inject = [
      ...
      (t.prototype.$onInit = function () {
        ;(this.collaborators = []), this.loadCollabs()
      }),
      ...
      (t.prototype.addCollaborator = function () {
        var e = this
        "dir" === this.collabType
          ? ((this.model.dirId = this.identifier), (this.model.shortcode = 0))
          : ((this.model.dirId = 0), (this.model.shortcode = this.identifier)),
          this.CollaboratorsService.createCollaborator(
            this.model,
            this.collabType
          ).then(function () {
            e.loadCollabs(), (e.model.email = "")
            var t = "dir" === e.collabType ? "folder" : "file"
            e.ToastService.showInfo(
              "Invited user to collaborate on this  " + t + "."
            )
          })
      }),
      (t.prototype.removeCollaborator = function (e) {
        var t = this,
          i =
            "<p>Are you sure you want to remove the collaborator <b>" +
            e.email +
            "</b> from this item?</p>",
          o = this.$mdDialog
            .confirm()
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.Collaborators", "dtCollaborators", {
            bindings: {
              identifier: "@",
              collabType: "@",
    ...
    return (
      ...
      (t.prototype.exportToSVG = function (e, t) {
        try {
          ...
          this.StreamDownloadService.downloadFromString(
            o + ".svg",
            "data:application/svg+xml;charset=utf-8," + encodeURIComponent(i)
          )
        } catch (e) {
          this.ToastService.showWarning(
            "SVG export failed, please try in Chrome"
          ),
            this.$log.error(e)
        }
      }),
      (t.prototype.exportToPNG = function (e, t) {
        ...
        if (this.BrowserSupportService.isSpecialSnowflakeBrowser())
          this.ToastService.showWarning(
            "PNG export is unsupported by your browser. Please try Chrome, Brave or Opera."
          )
        else
          try {
            ...
            this.ToastService.showWarning(
              "PNG export failed, please try in Chrome"
            ),
              this.$log.error(e)
          }
      }),
      (t.prototype.generateSVG = function (e, t) {
        ...
        o.setAttribute(
          "transform",
          "translate(" + -n.x + ", " + -n.y + ") scale(1,1)"
        )
        var r = i[0].innerHTML,
          a = $(r).wrapAll("<div>")
        return (
          a.find(".connector").remove(),
          (this.$rootScope.currentUser &&
            this.$rootScope.currentUser.hasProAccess) ||
            a
              .closest("svg")
              .append(
                "<text class='qdbd-link' x='10' y='20'>www.quickdatabasediagrams.com</text>"
              ),
          a.closest("div").html()
        )
      }),
      (t.prototype.getTopLeftPoint = function (e, t) {
        ...
        _.each(e.layout, function (e) {
          ;(i.x = _.min([e.x, i.x])), (i.y = _.min([e.y, i.y]))
        })
        var o = _.size(t.sections.tables) === _.size(e.layout)
        return (
          _.isEmpty(i)
            ? ((i.x = this.defaults.topLeft.x), (i.y = this.defaults.topLeft.y))
            : o ||
              ((i.x = _.min([this.defaults.topLeft.x, i.x])),
      ...
      (t = __decorate(
        [e.Service("QdbdApp.DiagramRenderer", "DiagramExportService")],
        t
      ))
    )
  })()
  ...
  !(function () {
    ...
    ;(t.$inject = [
      ...
      (t.prototype.getDiagramStyle = function () {
        ...
        return (
          this.SourceEditorService.isBasicPaletteActive() &&
            _.merge(e, this.QRendConfig.basicStyle),
          e
        )
      }),
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.DiagramRenderer", "dtDiagramRenderer", {
            templateUrl:
              "cache/modules/diagram-renderer/dt-diagram-renderer.html",
  ...
  !(function () {
    ...
    ;(t.$inject = [
      ...
      (t.prototype.resolveShortcodeLink = function () {
        this.shortcodeLink = this.shortcode
          ? this.$state.href(
              "root.standardShrinkable.diagram",
              {
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.DiagramRenderer", "dtShortcode", {
            bindings: {
              shortcode: "@",
            },
...
!(function (e) {
  var t = (function () {
    ...
    return (
      (t.$inject = ["QRendTableService", "QRendUtilsService"]),
      ...
      (t.prototype.highlightCached = function () {
        ...
        0 !== angular.element(".canvas").find("#" + e).length
      ...
      (t.prototype.resetHighlighting = function () {
        this.clearDimming(), this.clearHighlighting(), this.initializeCache()
      }),
      ...
      (t.prototype.getRelsToLeave = function (e, t) {
        return _.filter(e, function (e) {
          return (
            e.table1.tableIdentifier === t || e.table2.tableIdentifier === t
          )
        })
      }),
      ...
      (t.prototype.getTablesIdentifiersToLeave = function (e, t) {
        ...
        return (
          _.each(e, function (e) {
            var o
            e.table1.tableIdentifier === t
              ? (o = e.table2.tableIdentifier)
              : e.table2.tableIdentifier === t &&
                (o = e.table1.tableIdentifier),
              o &&
                !_.find(i, function (e) {
                  return e === o
                }) &&
      ...
      (t.prototype.getRelsToHl = function (e, t) {
        return _.filter(e, function (e) {
          return (
            e.table1.fieldIdentifier === t || e.table2.fieldIdentifier === t
          )
        })
      }),
      ...
      (t.prototype.getSecondaryRelMember = function (e, t, i) {
        ...
        return (
          e.table1.tableIdentifier === t &&
            e.table1.fieldIdentifier === i &&
            (o = e.table2),
          e.table2.tableIdentifier === t &&
            e.table2.fieldIdentifier === i &&
            (o = e.table1),
          o
        )
      }),
      ...
      (t.prototype.clearHighlighting = function () {
        ...
        e.find(".hl").removeClass("hl"), e.find(".fhl").remove()
      }),
      (t = __decorate(
        [e.Service("QdbdApp.DiagramRenderer", "QRendEventHighlightService")],
        t
      ))
    )
  })()
...
!(function (e) {
  var t = (function () {
    ...
    return (
          ...
          function c() {
            if (!u) {
              var o = _.filter(e.sections.relationships, function (e) {
                return (
                  e.table1.tableIdentifier === n ||
                  e.table2.tableIdentifier === n
                )
              })
              u = _.map(o, function (e) {
                return {
                  object: e,
                  element: p.querySelector(
                    "#" + w.QRendUtilsService.createRelationshipHtmlId(e)
                  ),
                }
              })
            }
            ...
            l.addEventListener("mouseup", function (t) {
              ;(f = null),
                b
                  ...
                  : (y || D
                      ? (y = null)
                      : w.QRendEventHighlightService.clickHighlight(e, n),
                    y &&
                      y.line &&
                      w.$rootScope.$broadcast(
                        "diagram-table-row-clicked",
                        y.line
                      ))
            }),
            l.addEventListener("mouseenter", function (t) {
              t &&
                (r(e.sections.tables[n], o, n, l),
                D || l.classList.add("hover"))
            }),
            l.addEventListener("mouseleave", function (e) {
              e &&
                (l.classList.remove("hover"), angular.element(".fa").remove())
            })
        }
        function r(e, t, o, n) {
          if (!n.querySelector(".fa")) {
            ...
            _.each(e.fields, function (c) {
              ...
              n.insertBefore(d, s), a(c, e, t, d, n)
            })
          }
        }
        function a(o, n, r, a, c) {
          ...
          function l(e, i) {
            ...
            var n = t.viewport.zoom / 100,
              r = u.offset()
            ;(f = h), (D = o), (x = c.width.baseVal.value * n)
            var a = m(e, n)
            E = {
              x: a - r.left,
              y: e.y - r.top,
          ...
          function h() {
            T(), M(w.QRendRelService.createConnectorPath(E, g, i))
          }
          function m(e, t) {
            return (
              document
              ...
              i.port.connector.radius * t
            )
          }
          function C() {
            D &&
              w.$rootScope.$broadcast("diagram-ports-connected", {
                fromLine: D.line,
                toTable: n.caption,
                toField: o.caption,
                toLine: o.line,
          ...
          function T() {
            "left" === E.orientation
              ? g.x > E.x + x + i.port.connector.sameSideThreshold &&
                ((E.orientation = "right"), (E.x += x))
              : g.x < E.x - x - i.port.connector.sameSideThreshold &&
                ((E.orientation = "left"), (E.x -= x))
          }
          function M(e) {
            ;(S = p.querySelector("#" + $))
              ? S.setAttribute("d", e)
              : p.appendChild(
                  w.QRendSvgService.svgRelationshipPathFactory($, e)
                )
          }
          function A() {
            s(), (E = null), (S = null), (x = null), (D = null), (y = null)
          }
          var k = w.QRendUtilsService.createConnectorHtmlClass(
              n.identifier,
              o.identifier
            ),
            $ = "temp-connection",
          ...
          a.addEventListener("mousedown", function (e) {
            ...
            a.addEventListener("mouseup", function (t) {
              b ||
                y !== o ||
                w.QRendEventHighlightService.clickHighlight(
                  e,
                  n.identifier,
                  o.identifier,
                  i
            ...
            "qdbdvirtualfield" !== o.identifier &&
              (a.addEventListener("mouseenter", function (e) {
                D && ((v = C), a.querySelector(".bg").classList.add("hover"))
              }),
              a.addEventListener("mouseleave", function (e) {
                D && ((v = A), a.querySelector(".bg").classList.remove("hover"))
              }),
              (function () {
        ...
        !(function () {
          ...
          function a(e) {
            if (w.SourceEditorService.isCanvasMouseZoomEnabled()) {
              ...
              ;(t.viewport.zoom += n),
                t.viewport.zoom > 200
                  ? ((t.viewport.zoom = 200), (r = !0))
                  : t.viewport.zoom < 10 && ((t.viewport.zoom = 10), (r = !0))
              ...
              if (!r && g) {
                ...
                ;(t.viewport.position.x = m.x), (t.viewport.position.y = m.y)
              }
              o(h, t.viewport),
                w.$rootScope.$broadcast("diagram-viewport-set", t.viewport),
                w.TrackingService.trackZoom(
                  t.viewport.zoom,
                  i > 0 ? "IN" : "OUT"
                )
            }
          ...
          (function () {
            ...
            function r(e, t) {
              w.$rootScope.$broadcast("diagram-link-removed", t.line), m.empty()
            }
            ...
            a.on("mouseenter", function (a) {
              if ((m.empty(), !D)) {
                var s = a.target,
                  ...
                  p = w.QRendSvgService.svgCircleFactory(
                    l.x,
                    l.y,
                    i.relationship.delete.circle.radius,
                    {
                      class: "dc",
                    }
                  ),
                  h = w.QRendSvgService.svgDeletePathX(
                    l,
                    i.relationship.delete.x.radius
                  )
                m.append(u),
                  m.append(p),
                  m.append(h),
      ...
      (t = __decorate(
        [e.Service("QdbdApp.DiagramRenderer", "QRendEventService")],
        t
      ))
    )
  })()
...
!(function (e) {
  var t = (function () {
    function t(e, t) {
      ;(this.QRendSvgService = e), (this.QRendUtilsService = t)
    }
    return (
      (t.$inject = ["QRendSvgService", "QRendUtilsService"]),
      (t.prototype.createRelationships = function (e, t, i) {
        ...
        return (
          _.each(e.sections.relationships, function (r) {
      ...
      (t.prototype.createRelationship = function (e, t, i, o) {
        ...
        return (
          (i.hash = this.QRendUtilsService.createRelationshipHtmlId(i)),
      ...
      (t.prototype.createRelationshipPath = function (e, t, i, o) {
        ...
        return this.isSelfReferencingRelationship(i)
          ? this.createSameSideRelationshipPath(n, r, o)
          : this.isVerticallyOverlappingRelationship(n, r, o)
          ? (this.adjustSameSidePortOrientation(n, r),
            this.createSameSideRelationshipPath(n, r, o))
          : (this.adjustDifferentSidePortOrientation(n, r),
      ...
      (t.prototype.isVerticallyOverlappingRelationship = function (e, t, i) {
        ...
        return (
          (e.x >= t.x - o && e.x <= t.adjustedRightX + o) ||
          (e.adjustedRightX >= t.x - o &&
            e.adjustedRightX <= t.adjustedRightX + o)
        )
      }),
      (t.prototype.adjustSameSidePortOrientation = function (e, t) {
        var i = Math.abs(e.x - t.x)
        Math.abs(e.adjustedRightX - t.adjustedRightX) < i &&
          ((e.x = e.adjustedRightX),
          (e.orientation = "right"),
      ...
      (t.prototype.createSameSideRelationshipPath = function (e, t, i) {
        var o = this.getCShapedBezier(e, t, i),
          n =
            "M" +
            this.QRendSvgService.formatPathPoint(o.port1) +
            " C " +
            this.QRendSvgService.formatPathPoint(o.controlPoint1) +
            ", " +
            this.QRendSvgService.formatPathPoint(o.controlPoint2) +
            ", " +
            this.QRendSvgService.formatPathPoint(o.port2)
      ...
      (t.prototype.createDifferentSideRelationshipPath = function (e, t, i) {
        var o = this.getSShapedBezier(e, t, i),
          n =
            ...
            this.QRendSvgService.formatPathPoint(o.port1) +
            " Q " +
            this.QRendSvgService.formatPathPoint(o.controlPoint) +
            ", " +
            this.QRendSvgService.formatPathPoint(o.portMidpoint) +
            " T " +
            this.QRendSvgService.formatPathPoint(t)
        return this.createRelationshipPathCommand(n, e, t, i)
      }),
      (t.prototype.createRelationshipPathCommand = function (e, t, i, o) {
        return (
          this.createCrowsFootPath(t, o) +
          " " +
          e +
          " " +
          this.createCrowsFootPath(i, o)
        )
      }),
      ...
      (t.prototype.adjustDifferentSidePortOrientation = function (e, t) {
        e.adjustedRightX < t.x
          ? ((e.x = e.adjustedRightX), (e.orientation = "right"))
          : e.x > t.adjustedRightX &&
            ((t.x = t.adjustedRightX), (t.orientation = "right"))
      }),
      ...
      (t.prototype.createPort = function (e, t, i, o) {
        var n = e.x,
          ...
          s = r + o.port.offset.x,
          c =
            o.table.header.height -
            o.table.field.height +
            (t.order + 1) * o.table.field.height
        return {
          x: a,
      ...
      (t.prototype.createDefaultCrowsFootPath = function (e, t) {
        ...
        return (
          this.createDotPath(n, e.y, t.port.defaultRadius) +
          " " +
          this.createLinePath(n, e.y, n + o * t.port.offset.x, e.y)
        )
      }),
      (t.prototype.createOneCrowsFootPath = function (e, t) {
        ...
        return (
          ...
          " " +
          this.createLinePath(
            n + o * t.port.one.offset.x,
            e.y + t.port.one.height,
            n + o * t.port.one.offset.x,
            e.y - t.port.one.height
          )
        )
      ...
      (t.prototype.createZeroOneCrowsFootPath = function (e, t) {
        ...
        return (
          ...
          this.createLinePath(
            n,
            e.y,
            n + o * (r - t.port.zeroOne.radius),
            e.y
          ) +
          " " +
          this.createCirclePath(n + o * r, e.y, t.port.zeroOne.radius) +
          " " +
          this.createLinePath(
            n + o * (r + t.port.zeroOne.radius),
            e.y,
      ...
      (t.prototype.createZeroManyCrowsFootPath = function (e, t) {
        ...
        return (
          this.createDotPath(n, e.y, t.port.defaultRadius) +
          " " +
          this.createLinePath(n, e.y, n + o * t.port.many.length, e.y) +
          " " +
          this.createFootPath(n, e.y, o, t) +
          " " +
          this.createCirclePath(
            n + o * (t.port.offset.x - t.port.zeroMany.radius),
            e.y,
            t.port.zeroMany.radius
          )
        )
      }),
      (t.prototype.createLinePath = function (e, t, i, o) {
        ...
        return (
          ...
          n +
          " " +
          this.QRendSvgService.formatPathCoordinates(i, o)
        )
      }),
      (t.prototype.createFootPath = function (e, t, i, o) {
        var n = this.createDotPath(
            e,
            t + o.port.many.height,
            o.port.defaultRadius
          ),
          r = this.QRendSvgService.formatPathCoordinates(
            e,
            t + o.port.many.height
          )
        return (
          ...
          r +
          " " +
          this.QRendSvgService.formatPathCoordinates(
            e + i * o.port.many.length,
            t
          ) +
          " " +
          this.QRendSvgService.formatPathCoordinates(
          ...
          " " +
          this.createDotPath(e, t - o.port.many.height, o.port.defaultRadius)
        )
      }),
      (t.prototype.createDotPath = function (e, t, i) {
        return i <= 0
          ? ""
          : this.createCirclePath(e, t, i) +
              " " +
              this.createDotPath(e, t, i - 0.5)
      }),
      ...
      (t.prototype.getCShapeBezierMidpoint = function (e) {
        for (
          var t = [e.port1, e.controlPoint1, e.controlPoint2, e.port2],
            i = [],
            o = 1;
          o < 4;
          o++
        ...
        return (
          i.push(this.calculateMidpoint(i[0], i[1])),
      ...
      (t.prototype.createConnectorPath = function (e, t, i) {
        return (
          (t.type = "none"),
          this.isSameSameSideConnection(e, t, i)
            ? this.createSameSideRelationshipPath(e, t, i)
            : this.createDifferentSideRelationshipPath(e, t, i)
        )
      }),
      (t.prototype.isSameSameSideConnection = function (e, t, i) {
        return "left" === e.orientation
          ? e.x - i.port.connector.sameSideThreshold < t.x
          : e.x + i.port.connector.sameSideThreshold > t.x
      }),
      (t = __decorate(
        [e.Service("QdbdApp.DiagramRenderer", "QRendRelService")],
        t
      ))
    )
  })()
  ...
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.createStyleSheet = function (e) {
        ...
        return (t.textContent = this.buildStyle(i)), t
      }),
      ...
      (t = __decorate(
        [e.Service("QdbdApp.DiagramRenderer", "QRendStyleService")],
        t
      ))
    )
  })()
...
!(function (e) {
  var t = (function () {
    function t(e) {
      ;(this.QRendConfig = e), (this.shapes = this.QRendConfig.shapes)
    }
    return (
      (t.$inject = ["QRendConfig"]),
      ...
      (t.prototype.svgPkIconFactory = function (e, t, i) {
        var o = {
          ...
          transform:
            ...
            e +
            ", " +
            (t + i.table.field.icon.pk.offset.y) +
            ")" +
            " " +
            ("scale(" + i.table.field.icon.pk.scale + ")"),
        }
      ...
      (t.prototype.svgUniqIconFactory = function (e, t, i) {
        var o = {
          ...
          transform:
            ...
            e +
            ", " +
            (t + i.table.field.icon.uniq.offset.y) +
            ")" +
            " " +
            ("scale(" + i.table.field.icon.uniq.scale + ")"),
        }
      ...
      (t.prototype.svgIndexIconFactory = function (e, t, i) {
        var o = {
          ...
          transform:
            ...
            e +
            ", " +
            (t + i.table.field.icon.index.offset.y) +
            ")" +
            " " +
            ("scale(" + i.table.field.icon.index.scale + ")"),
        }
        return this.svgPathFactory(this.shapes.indexShape, o)
      }),
      (t.prototype.svgPathFactory = function (e, t) {
        return this.svgElementFactory(
          "path",
          _.extend(
            {
              d: e,
      ...
      (t.prototype.svgCircleFactory = function (e, t, i, o) {
        ...
        return (
          n.color && ((n.stroke = n.color), (n.fill = n.color), delete n.color),
      ...
      (t.prototype.svgDeletePathX = function (e, t) {
        var i = {
          ...
          a =
            "M" +
            this.formatPathPoint(i) +
            " " +
            this.formatPathPoint(o) +
            " M" +
            this.formatPathPoint(n) +
            " " +
            this.formatPathPoint(r)
      ...
      (t = __decorate(
        [e.Service("QdbdApp.DiagramRenderer", "QRendSvgService")],
        t
      ))
    )
  })()
  ...
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.createTables = function (e, t, i) {
        ...
        return (
          _.each(e.sections.tables, function (e, r) {
      ...
      (t.prototype.createTable = function (e, t, i, o) {
        ...
        var s = this.QRendSvgService.svgRootFactory({
            ...
            height:
              o.table.header.height +
              2 * o.table.contentPadding.height +
              o.table.field.height * _.size(e.fields),
            x: r.x,
            y: r.y,
      ...
      (t.prototype.createTableHeader = function (e, t, i) {
        return [
          this.QRendSvgService.svgRectFactory({
      ...
      (t.prototype.createTableBackground = function (e, t, i) {
        ...
        return (
          i.isSupportedBrowser || (n.y = i.table.header.height),
          this.QRendSvgService.svgRectFactory(n)
        )
      }),
      (t.prototype.createTableField = function (e, t, i, o, n) {
        var r =
            n.table.header.height +
            n.table.contentPadding.height +
            n.table.field.height * t,
      ...
      (t.prototype.createTableFieldText = function (e, t, i, o, n) {
        ...
        if (e.type) {
          ...
          a.appendChild(
            this.QRendSvgService.svgTSpanFactory(s, {
      ...
      (t.prototype.getTableFieldCssClass = function (e) {
        var t = "tf"
        return e.isPk ? (t += " pk") : e.isFk && (t += " fk"), t
      }),
        ...
        return (
          _.max(
            _.map(e, function (e) {
              ...
              return (
                e.isPk &&
                  ((s += i.table.field.icon.pk.width),
                  r && (s += i.table.field.icon.rightOffset)),
                e.isUniq &&
                  ((s += i.table.field.icon.uniq.width),
                  r && (s += i.table.field.icon.rightOffset)),
                e.isIdx &&
                  ((s += i.table.field.icon.index.width),
                  r && (s += i.table.field.icon.rightOffset)),
                s
              )
            })
      ...
      (t.prototype.createFieldBackground = function (e, t) {
        var i =
            t.table.header.height +
            t.table.contentPadding.height +
            t.table.field.height * e.fieldIndex,
        ...
        if (
          ...
          var n = this.createFieldConnectors(
            e.tableIdentifier,
            e.fieldIdentifier,
            e.tableWidth,
            t
      ...
      (t.prototype.createFieldConnectors = function (e, t, i, o) {
        ...
        return [
          this.QRendSvgService.svgConnectorFactory(0, n + " l", r),
          this.QRendSvgService.svgConnectorFactory(i, n + " r", r),
        ]
      }),
      (t = __decorate(
        [e.Service("QdbdApp.DiagramRenderer", "QRendTableService")],
        t
      ))
    )
  })()
...
!(function (e) {
  var t = (function () {
    function t(e, t) {
      ;(this.$rootScope = e), (this.CryptoService = t)
    }
    return (
      (t.$inject = ["$rootScope", "CryptoService"]),
      ...
      (t.prototype.getSchemaField = function (e, t, i) {
        ...
        return e.sections.settings.isCaseSensitive
          ? o.fields[i]
          : _.find(o.fields, function (e, t) {
      ...
      (t.prototype.createRelationshipHtmlId = function (e) {
        return this.CryptoService.getUniqHash(
          "r" +
            e.table1.tableIdentifier +
            e.table1.fieldIdentifier +
            e.table2.tableIdentifier +
            e.table2.fieldIdentifier
        )
      }),
      ...
      (t.prototype.calculateTextWidth = function (e, t, i) {
        var o = this.get2dCtx()
        return (o.font = i + "px " + t), o.measureText(e).width
      }),
      ...
      (t.prototype.getTableFieldTypeCaption = function (e, t) {
        if (this.isObfuscatedField(e)) return ""
        var i = e.type
        if (!i || !_.trim(i)) {
          if (!t || !t.defaultType) return ""
          i = t.defaultType
        }
      ...
      (t = __decorate(
        [e.Service("QdbdApp.DiagramRenderer", "QRendUtilsService")],
        t
      ))
    )
  })()
  ...
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.ensureAllTableDataSet = function (e, t, i) {
        ...
        this.SourceEditorService.ensureViewportExists(t),
          ...
          _.each(e.sections.tables, function (e) {
            t.sharedMetadata.defaultType &&
              _.each(e.fields, function (e) {
                e.type ||
                  "qdbdvirtualfield" === e.identifier ||
                  (e.type = t.sharedMetadata.defaultType)
              }),
              t.layout[e.identifier] ||
                ((t.layout[e.identifier] = {
                  x:
                    i.layout.nonExisting.padding +
                    o * i.layout.nonExisting.width,
      ...
      (t.prototype.optimizeCoordinateValues = function (e) {
        _.each(e.layout, function (e) {
          ;(e.x = _.round(e.x, 2)), (e.y = _.round(e.y, 2))
        })
      }),
      ...
      (t.prototype.clear = function () {
        for (var e = this.getCanvas(); e.lastChild; ) e.removeChild(e.lastChild)
      }),
      ...
      (t.prototype.createMainGroup = function (e) {
        ...
        return this.setDrawingTransformation(t, e.viewport), t
      }),
      ...
      (t = __decorate(
        [e.Service("QdbdApp.DiagramRenderer", "QRendService")],
        t
      ))
    )
  })()
...
!(function (e) {
  !(function () {
    function t(e, t) {
      ;(this.$scope = e), (this.AccountService = t), (this.credentials = {})
    }
...
!(function (e) {
  !(function () {
    function t(e) {
      ;(this.MessageScreenService = e), this.init()
    }
    ;(t.$inject = ["MessageScreenService"]),
      ...
      (t = __decorate(
        [e.Controller("QdbdApp.MessageScreen", "MessageScreenCtrl")],
        t
      ))
  })()
})(QdbdApp || (QdbdApp = {}))
    ...
    return (
      ...
      (t.prototype.showMessage = function (e, t) {
        this.resetErrorState(),
          ...
          (this.message.redirectRoute = e.redirectRoute
            ? e.redirectRoute
            : "root.standardShrinkable.home"),
          this.$state.go(t)
      }),
      (t.prototype.resetErrorState = function () {
        ;(this.message.status = ""), (this.message.header = "")
      }),
      (t = __decorate(
        [e.Service("QdbdApp.MessageScreen", "MessageScreenService")],
        t
      ))
    )
  })()
  ...
  !(function () {
    ...
    ;(t.$inject = ["AccountService", "MessageScreenService"]),
      (t.prototype.changeEmail = function () {
        var e = this
        this.AccountService.changeEmail(this.changeEmailModel).then(
          function () {
            var t = {
              header: "Please confirm your new e-mail",
              message:
                "A confirmation e-mail was sent to your new email, after you confirm it your e-mail will be updated.",
            }
  ...
  !(function () {
    ...
    ;(t.$inject = ["AccountService", "MessageScreenService"]),
      (t.prototype.changePassword = function () {
        var e = this
        this.AccountService.changePassword(this.changePasswordModel).then(
          function () {
            var t = {
      ...
      (t = __decorate(
        [e.Controller("QdbdApp.Register", "ChangePasswordCtrl")],
        t
      ))
  })()
})(QdbdApp || (QdbdApp = {}))
...
!(function (e) {
  !(function () {
    ...
    ;(t.$inject = ["$state", "ToastService", "AccountService"]),
      ...
      (t = __decorate(
        [e.Controller("QdbdApp.Register", "ConfirmEmailCtrl")],
        t
      ))
  })()
})(QdbdApp || (QdbdApp = {}))
  ...
  !(function () {
    ...
    ;(t.$inject = ["AccountService", "MessageScreenService"]),
      (t.prototype.forgotPassword = function () {
        var e = this
        this.AccountService.forgotPassword(this.forgotPasswordModel).then(
          function () {
            var t = {
              header: "Email sent",
              message:
                "An email with password reset details has been sent to your email address",
            }
            e.MessageScreenService.showSuccess(t)
          }
        )
      ...
      (t = __decorate(
        [e.Controller("QdbdApp.Register", "ForgotPasswordCtrl")],
        t
      ))
  })()
})(QdbdApp || (QdbdApp = {}))
  ...
  !(function () {
    ...
    ;(t.$inject = ["$state", "ToastService", "AccountService"]),
      (t.prototype.resetPassword = function () {
        var e = this
        this.AccountService.validatePassword(this.resetPasswordModel.password)
          .isValid &&
          ((this.resetPasswordModel.userId = this.$state.params.userId),
          (this.resetPasswordModel.token = this.$state.params.token),
          this.AccountService.resetPassword(this.resetPasswordModel).then(
            function () {
      ...
      (t = __decorate(
        [e.Controller("QdbdApp.Register", "ResetPasswordCtrl")],
        t
      ))
  })()
})(QdbdApp || (QdbdApp = {}))
  ...
  !(function () {
    function t(e, t, i, o, n, r, a, s, c, d, l) {
      ;(this.$rootScope = e),
        ...
        (this.$rootScope.stateIncludes = this.RoutingService.stateIncludes.bind(
          this
        ))
    }
    ;(t.$inject = [
      ...
      (t.prototype.setPageTitle = function (e) {
        e.data && e.data.title
          ? e.data.usesCustomPageTitleHandler ||
            (this.$rootScope.pageTitle = e.data.title + " - QuickDBD")
  ...
  !(function () {
    ...
    ;(t.$inject = [
      ...
      (t.prototype.initializeTree = function () {
        return this.dirTreeState.showSharedDiagrams
          ? this.getSharedFlatTree()
          : this.getFlatTree()
      }),
      (t.prototype.getFlatTree = function () {
        var e = this
        return (
          (this.dirTreeState.showSharedDiagrams = !1),
          (this.dirTree = null),
          this.resolveIndex(),
          this.SchemaDirService.getDirTree().then(function (t) {
            return (e.dirTree = t), e.autoExpandTreeItems(), t
          })
        )
      }),
      (t.prototype.getSharedFlatTree = function () {
        var e = this
        return (
          (this.dirTreeState.showSharedDiagrams = !0),
          (this.dirTree = null),
          this.resolveIndex(),
      ...
      (t.prototype.autoExpandTreeItems = function () {
        var e = this
        if (
          (_.each(this.dirTree, function (t) {
          ...
          this.SchemaDirService.cache.expandDir(t), this.expandTreeItems(t, !0)
        }
      }),
      (t.prototype.shouldExpandDirTreeItem = function (e) {
        return (
          "dir" === e.itemType &&
          this.SchemaDirService.cache.isDirExpanded(e.id)
        )
      }),
      (t.prototype.expandTreeItems = function (e, t) {
        _.each(this.dirTree, function (i) {
          ;(("dir" === i.itemType && i.id === e) ||
            ("dir" !== i.itemType && i.parentId === e)) &&
            (i.isExpanded = t)
        })
      }),
      (t.prototype.onTreeItemClick = function (e) {
        "empty-dir-holder" !== e.itemType &&
          ("dir" === e.itemType
            ? (e.isExpanded
                ? this.SchemaDirService.cache.collapseDir(e.id)
                : this.SchemaDirService.cache.expandDir(e.id),
              this.expandTreeItems(e.id, !e.isExpanded))
            : "file" === e.itemType
            ? this.goToDiagram(e.shortCode)
            : this.addSchema(e))
      }),
      ...
      (t.prototype.addSchema = function (e) {
        ...
        this.SchemaService.createDiagramInDirWithNamePrompt(i).then(
          function () {
            t.SchemaDirService.cache.expandDir(i), t.initializeTree()
          }
        )
      }),
      ...
      (t.prototype.renameItem = function (e) {
        var t = this,
          i = this.$mdDialog
            .prompt()
            .title("Rename " + ("dir" === e.itemType ? "folder" : "file"))
        ...
        this.$mdDialog.show(i).then(function (i) {
          if (i) {
            ;("dir" === e.itemType
              ...
              t.initializeTree(),
                t.ToastService.showInfo(
                  ("dir" === e.itemType ? "Folder" : "File") +
                    " successfully renamed"
                )
            })
          } else t.ToastService.showWarning("Empty names not allowed")
        })
      }),
      (t.prototype.collaborate = function (e) {
        this.CollaboratorsService.collaborate(
          e.shortCode || e.id,
          e.itemType,
          e.isOwnedByCurrentUser
        )
      }),
      (t.prototype.deleteItem = function (e) {
        var t = this,
          ...
          n =
            ...
            (e.name ? "<em>" + e.name + "</em>" : "this item") +
            "?</p>"
        "dir" === e.itemType &&
          (n +=
            "<p>Deleting this folder will also delete all files within it.</p>")
        var r = this.$mdDialog
          .confirm()
          .title(o)
          .htmlContent(n)
        ...
        this.$mdDialog.show(r).then(function () {
          i &&
            (t.SourceEditorService.clearLocalShortcode(),
            t.$rootScope.$broadcast("unload-editor-diagram")),
            ("dir" === e.itemType
              ? t.SchemaDirService.deleteDir(e.id)
              : t.SchemaService.deleteDiagram(e.shortCode)
            ).then(function () {
              t.ToastService.showInfo(
                ("dir" === e.itemType ? "Folder" : "File") +
      ...
      (t.prototype.leaveCollab = function (e) {
        var t = this,
          i =
            "<p>Are you sure you want to leave this " +
            ("dir" === e.itemType ? "folder" : "file") +
            "?</p>",
          o = this.$mdDialog
            .confirm()
            .title("Confirm share leaving")
            .htmlContent(i)
            .ok("Yes")
            .cancel("No")
            .clickOutsideToClose(!0)
        this.$mdDialog.show(o).then(function () {
          t.CollaboratorsService.leaveCollab(e.collabPermissionId).then(
            t.initializeTree.bind(t)
          )
        })
      }),
      ...
      (t.prototype.onDragEnter = function () {
        var e = this
        return function (t, i) {
          e.dirTreeState.showSharedDiagrams ||
            (angular.element(".drag-over").removeClass("drag-over"),
        ...
        return function (t, i, o, n) {
          if (!e.dirTreeState.showSharedDiagrams) {
            ...
            i.removeClass("drag-over"),
              "true" === i.attr("is-droppable-dir")
                ? (e.SchemaDirService.cache.expandDir(r),
                  e.SchemaService.moveDiagramToDir({
                    parentId: r,
                    shortcode: n.shortCode,
                  }).then(e.initializeTree.bind(e)))
                : -1 === r &&
                  e.ToastService.showWarning(
                    "Items can't be moved to 'Unsaved Files'"
                  )
          }
        }
      }),
      ...
      (t.prototype.addRootSchema = function () {
        var e = this
        this.TrackingService.trackNewFile(),
          this.SchemaService.createDiagramInDirWithNamePrompt(0).then(
            function () {
              e.SchemaDirService.cache.expandDir(0), e.initializeTree()
            }
          )
      }),
      (t.prototype.getDirIconClass = function (e) {
        return -1 === e.id && "Unsaved Files" === e.name
          ? "mdi-file-hidden"
          : e.isExpanded
          ? "mdi-folder-open"
          : "mdi-folder"
      ...
      (t.prototype.resolveIndex = function () {
        this.tabIndex = this.SchemaDirService.dirTreeState.showSharedDiagrams
          ? 1
          : 0
      }),
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.SchemaDir", "dtSchemaDir", {
  ...
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.goToFirstDiagram = function (e) {
        ...
        t &&
          this.$state.go("root.standardShrinkable.diagram", {
      ...
      (t.prototype.cacheFactory = function () {
        ...
        return {
          expandDir: function (t) {
            _.contains(e.expandedDirIds, t) ||
              (e.expandedDirIds.push(t), e.saveExpandedDirIds())
          },
          collapseDir: function (t) {
            e.removeExpandedDirId(t), e.saveExpandedDirIds()
          },
...
!(function (e) {
  !(function () {
    ...
    ;(t.$inject = ["$scope", "SchemaService", "PagingService"]),
      (t.prototype.$onInit = function () {
        ;(this.pager = this.PagingService.pagerFactory(
          this.filter,
          this.diagrams,
          this.loadDiagrams.bind(this),
          "root.standard.admin.diagramList"
        )),
          this.$scope.$watch(
            "DtSchemaListVM.filter",
            this.pager.onFilterChanged.bind(this),
            !0
          )
      }),
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.Schema", "dtSchemaList", {
            bindings: {
              filter: "=",
            },
            templateUrl:
              "cache/modules/schema/dt-schema-list/dt-schema-list.html",
  ...
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.exportToSQL = function (e, t, i, o, n) {
        var r = this
        if (
          (this.TrackingService.trackExportToSql(i),
          0 === Object.keys(t.errors).length)
        ) {
          var a = this.createExportFileName(n)
          this.$http
            .post("api/v1/schemaExport/toSql", {
              shortcode: e,
          ...
          this.ToastService.showError(
            "Schema continas errors and cannot be exported."
          )
      }),
      (t.prototype.exportToDoc = function (e, t, i, o, n) {
        if (
          (this.TrackingService.trackExportToDoc(i),
          0 === Object.keys(t.errors).length)
        ) {
      ...
      (t.prototype.convertSchemaToExportModel = function (e) {
        ...
        return (
          _.each(i.tables, this.convertTableAndFieldNames.bind(this)),
      ...
      (t.prototype.convertTableAndFieldNames = function (e) {
        ;(e.identifier = e.caption),
          delete e.caption,
          (e.fields = _.values(
            _.filter(e.fields, function (e) {
              return "qdbdvirtualfield" !== e.identifier
            })
          )),
          _.each(e.fields, function (e) {
            ;(e.identifier = e.caption), delete e.caption
          })
      }),
      ...
      (t.prototype.convertRelTableFieldName = function (e, t) {
        var i = _.find(e.sections.tables, function (e) {
            return (
              e.identifier.toLowerCase() === t.tableIdentifier.toLowerCase()
            )
          }),
          o = _.find(i.fields, function (e) {
            return (
              e.identifier.toLowerCase() === t.fieldIdentifier.toLowerCase()
            )
          })
  ...
  var t = (function () {
    ...
    return (
            ...
            _.isString(t) && (t = JSON.parse(t)),
              t.error &&
                "Requests from referer https://www.googleapis.com/ are blocked." ===
                  t.error.message &&
                this.DialogService.showDialogNotification(
                  "Access to Google Firebase is blocked - either by a firewall or an ad-blocker. It's required for the app to work. Please ensure Firebase is not blocked and then refresh the browser."
                )
          } catch (e) {
            console.log(e),
      ...
      (t.prototype.editorFactory = function (e, t, i) {
        ...
        return (
          this.registeerDiagramUnreadableHandler(o, n),
          ...
          function (e) {
            t &&
              ...
              (e && "PERMISSION_DENIED" === e.code
                ? (i.ToastService.showError("Diagram does not exist."),
                  t.firebaseAdapter_.ready_ && t.setText(""),
                  i.disposeFirepad(t))
                : e && i.ToastService.showError(e.message))
          }
        )
      }),
      (t.prototype.registerDiagramUnwritableHandler = function (e) {
        var t = this
        e.child("writeCheck").set(
          firebase.database.ServerValue.TIMESTAMP,
          function (e) {
            e && "PERMISSION_DENIED" === e.code
              ? t.$rootScope.$broadcast("diagram-writable-changed", !1)
              : e && t.ToastService.showError(e.message)
          }
        )
      }),
      ...
      (t.prototype.registerOnDisconnectHandler = function () {
        var e = this
        this.isDisconnectHandlerInitialized ||
          this.getConnectionReference().on("value", function (t) {
            t.val()
              ? (e.isDisconnectHandlerInitialized &&
                  e.DialogService.closDialogNotification(),
                (e.isDisconnectHandlerInitialized = !0))
              : e.isDisconnectHandlerInitialized &&
                e.DialogService.showDialogNotification(
                  "Uh-oh. We can't connect to our server. Please check your internet connection."
                )
          })
      }),
      ...
      (t.prototype.dbSave = function (e, t, i, o, n, r) {
        if (!t || !i || !this.currentUserExists()) return this.$q.resolve()
        var a = this.$q.defer()
        return (
          (n
            ? this.getUserChildReference(e, this.getCurrentUserUid(), t)
            : this.getChildReference(e, t, r))[o](
            this.clearUndefinedProperties(i),
            function (e) {
      ...
      (t.prototype.setDiagramSchema = function (e, t) {
        if (!e || !t || !this.currentUserExists()) return this.$q.resolve()
        var i = this.headlessFactory(e),
          o = this.$q.defer()
        return (
          i.setText(t, function (e, t) {
            i.dispose(), e || !t ? o.reject() : o.resolve()
          }),
          o.promise
        )
      }),
      ...
      (t.prototype.removeDiagramLayoutTables = function (e, t) {
        return e && t && 0 !== t.length
          ? this.getChildReference("diagramLayout", e).transaction(function (
              e
            ) {
              return (
                _.each(t, function (t) {
      ...
      (t.prototype.setDiagram = function (e) {
        return e
          ? this.setDiagramSchema(e.shortcode, e.schema)
          : this.$q.resolve()
      }),
      (t.prototype.saveDiagram = function (e) {
        var t = [
          this.setDiagram(e),
          this.setDiagramSharedMetadata(e.shortcode, e.sharedMetadata),
          this.setDiagramLayout(e.shortcode, e.layout),
          this.setDiagramViewport(e.shortcode, e.viewport),
        ]
        return this.$q.all(t)
      }),
      ...
      (t.prototype.saveDiagrams = function (e) {
        var t = this
        if (!e || 0 === e.length) return this.$q.resolve()
        var i = []
        return (
          _.each(e, function (e) {
      ...
      (t.prototype.registerOnValueChangedHandler = function (e, t, i, o) {
        var n = this,
          r = o
            ? this.getUserChildReference(e, o, t)
            : this.getChildReference(e, t)
        return (
          r.on(
            "value",
            function (e) {
      ...
      (t.prototype.registerViewportListener = function (e, t) {
        return this.registerOnValueChangedHandler(
          "diagramViewport",
          e,
          t,
        ...
        return (
          Object.keys(e).forEach(function (i) {
            e[i] && "object" == typeof e[i]
              ? t.clearUndefinedProperties(e[i])
      ...
      (t = __decorate(
        [e.Service("QdbdApp.Schema", "SchemaFirebaseService")],
        t
      ))
    )
  })()
...
!(function (e) {
  var t = (function () {
    ...
    return (
      (t.$inject = ["$http", "$q", "MessageScreenService", "TrackingService"]),
      (t.prototype.importFromSQL = function (e, t) {
        var i = this
        return (
          this.TrackingService.trackImportFromSql(t),
          this.$http
            .post("api/v1/schemaImport/fromSql", {
              sql: e,
              importType: t,
              parsedSql: "",
            })
      ...
      (t.prototype.onImportFromSql = function (e, t) {
        var i = t.errors,
          o =
            "<p><strong>Important: You may lose information when importing your database schema because QuickDBD does not support all databases features. For example, QuickDBD will not import compound indexes, enums or triggers. <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Therefore, DO NOT attempt to use QuickDBD for round-trip engineering.</strong></p> "
        if (t.parsedSql)
          return (
            i.length ||
        ...
        if (
          ((i && i.length) || this.showUnhandledErrorsMessage(e, o),
          i && i.length)
        ) {
      ...
      (t.prototype.showUnhandledErrorsMessage = function (e, t) {
        ...
        var o =
          "Sorry, QuickDBD could not understand your schema file. We have logged this and will investigate it. Please run it against " +
          i +
          " database and check it is valid."
        this.MessageScreenService.showError({
  ...
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.migrateToFirebase = function () {
        var e = this
        return this.isMigrationToFirebaseRequired()
      ...
      (t.prototype.isMigrationToFirebaseRequired = function () {
        return (
          ...
          !this.$rootScope.currentUser.firebaseUserId
        )
      }),
      (t.prototype.schemaToDiagramModels = function (e) {
        return e && 0 !== e.length
          ? _.map(e, function (e) {
              ...
              return e.layout && (i.layout = angular.copy(e.layout)), i
            })
          : []
      }),
      (t.prototype.backupLocalSchemas = function () {
        ...
        if (this.RUN_DIAGNOSTICS) {
          ...
          console.log(
            ...
            console.log(
              "Previous users diagrams to backup: " +
      ...
      (t.prototype.migrateOwnServerSchemas = function () {
        ...
        return this.$http.get("api/v1/schema/getOwnSchemas").then(function (t) {
          ...
          return (
            e.RUN_DIAGNOSTICS &&
              console.log("Server diagrams to migrate: " + i.length),
      ...
      (t.prototype.migrateOwnLocalUnsavedSchemas = function (e) {
        ...
        return (
          this.updateWithServerShotcodes(i, e),
          this.RUN_DIAGNOSTICS &&
            (console.log("Local diagrams to migrate: " + i.length),
            console.log(
              "Local diagram shortcodes:",
              _.sortBy(_.map(t || [], "shortcode"))
            ),
            console.log(
              "Server diagram shortcodes:",
              _.sortBy(_.map(e || [], "shortcode"))
            )),
      ...
      (t.prototype.backupAndRemoveLocalSchemas = function () {
        var e = this
        return this.AccountService.isUserLoggedIn()
          ? this.backupLocalSchemas().then(function () {
              e.removeLocalSchemas()
            })
          : this.$q.resolve()
      }),
      ...
      (t = __decorate(
        [e.Service("QdbdApp.Schema", "SchemaMigrationService")],
        t
      ))
    )
  })()
  ...
  var thing = (function () {
    function t(e, t, i, o) {
      ;(this.$rootScope = e),
        ...
        (this.AccountService = i),
        (this.TrackingService = o),
        (this.allowedRelTypes = _.map(
          this.QdbdParserConfig.allowedRelTypes,
          "symbol"
        ))
    }
    return (
      ...
      (t.prototype.parseSource = function (e, t, i) {
        ;(this.settings = t), (this.security = i), this.initializeFields()
        ...
        return (
          t && (t.tableCount = _.size(this.sections.tables) || 0),
      ...
      (t.prototype.getSection = function (e, t) {
        var i = e.split("[" + t + "]")
        if (1 !== i.length) return _.first(i.pop().split("["))
      }),
          ...
          _.each(i, function (e, i) {
            ...
            if (
              (d.comment
                ...
                : c &&
                  (a ||
                    (t.sections.comments.push.apply(t.sections.comments, o),
                    (o = []))),
              d.data.match(/\t/g))
            ) {
              t.addError(
                (i + 1).toString(),
                "Whitespace expected, tab character found (To untabify the whole document use: Menu -> Edit -> Untabify)"
              )
            }
            if (
              (d.data && (a = !0), !((c && "tables" !== n) || (!c && !d.data)))
            ) {
              var l = {
                line: (i + 1).toString(),
                value: d.data,
      ...
      (t.prototype.replaceSectionAliases = function (e) {
        return this.QdbdParserConfig.aliasSchemaSections[e]
          ? this.QdbdParserConfig.aliasSchemaSections[e]
          : e
      }),
      (t.prototype.validateSection = function (e, t, i) {
        ...
        if (_.includes(t, e))
          return (
            this.addError(i, "Section '[" + e + "]' is already defined"), !1
          )
        ...
        return (
          ...
          (this.addError(
            ...
            "Section '[" +
              e +
              "]' is out of order. It must be defined before: '[" +
              r.join(", ") +
              "]'"
          ),
          !1)
      ...
      (t.prototype.parseSettings = function (e) {
        ...
        _.each(e, function (e) {
          ...
          n
            ? _.includes(n, " ")
              ? t.addError(e.line, "Setting key cannot contain whitespace")
              : r
              ? t.sections.settings[n]
                ? t.addError(e.line, "Setting '" + o + "' already defined")
                : (("casesensitive" !== n && "casesensitivity" !== n) ||
                    ((n = "casesensitive"),
                    (r = t.parseCaseSensitiveSettingValue(r, e.line))),
                  "position" === n &&
                    (r = t.parsePositionSettingValue(r, e.line)),
                  "zoom" === n && (r = t.parseZoomSettingValue(r, e.line)),
                  (t.sections.settings[n] = r))
              : t.addError(e.line, "Setting value missing")
            : t.addError(e.line, "Setting key missing")
        }),
        ...
        return (
          "off" === e.toLowerCase()
            ...
            : t &&
              this.addError(
                t,
                "Invalid 'CaseSensitive' value (allowed: 'on', 'off')"
              ),
          i
        )
      }),
      (t.prototype.parsePositionSettingValue = function (e, t) {
        ...
        if (t && 2 !== i.length)
          ...
          if (!t || this.isNumeric(o)) {
            ...
            this.addError(
              t,
              "Invalid Y coordinate '" + (r || void 0) + "', number expected"
            )
          } else
            this.addError(
              t,
              "Invalid X coordinate '" + (o || void 0) + "', number expected"
            )
        }
      }),
      (t.prototype.parseZoomSettingValue = function (e, t) {
        ...
        return (
          t &&
            (!this.isNumeric(i) || i < 10 || i > 200) &&
            this.addError(
              t,
              "Invalid 'Zoom' value (allowed: number between 10 and 200)"
            ),
          i
        )
      }),
      (t.prototype.resolveDefaultSettings = function () {
        _.isBoolean(this.sections.settings.casesensitive) ||
          (this.sections.settings.casesensitive = !1),
          this.sections.settings.position ||
            (this.sections.settings.position = {
              x: 0,
              y: 0,
            }),
          this.isNumeric(this.sections.settings.zoom) ||
            (this.sections.settings.zoom = 100)
      }),
      ...
      (t.prototype.parseTable = function (e) {
        ...
        _.each(e, function (e, n) {
          if (i.isTableFieldsSeparator(e.value))
            return (
              0 === n && i.addError(e.line, "Table name not defined"),
              void (o = !0)
            )
          if (0 !== n) {
            if (t)
              ...
              } else i.parseTableMetadata(t, e)
          } else t = i.parseTableName(e)
        })
      }),
      (t.prototype.parseTableName = function (e) {
        ...
        if (i) {
          if (!this.sections.tables[i.tableIdentifier]) {
            if (
              ((this.sections.tables[i.tableIdentifier] = {
              ...
              ;(this.sections.tables[i.tableIdentifier].caption = o),
                this.TrackingService.trackEditor(
                  _.size(this.sections.tables),
                  "TableLimitReached",
                  "table_limit_reached"
                )
            }
          ...
          this.addError(
            e.line,
            "Table '" + i.tableCaption + "' already defined"
          )
        }
      }),
      ...
      (t.prototype.parseTableMetadata = function (e, t) {
        _.startsWith(t.value, "rel")
          ? this.parseTableMetadataRelationship(e, t)
          : this.addError(
              t.line,
              "Unrecognized table metadata '" + t.value + "'"
            )
      }),
      (t.prototype.parseTableMetadataRelationship = function (e, t) {
        var i = this.splitByWhitespaceAndRemoveEmptyStrings(t.value)
        i.length > 3
          ? this.addError(t.line, "Unknown relationship param '" + i[3] + "'")
        ...
        if (0 !== i.length) {
          ...
          if (n) {
            ...
            for (
              ...
              if (s > -1)
                if (c === s + 1) {
                  if (this.isRelationshipTypeToken(d.value)) {
                    c === i.length - 1 &&
                      this.addError(t.line, "Relationship key cannot be empty")
                    continue
                  }
                  s = -1
                } else if (c === s + 2) {
              ...
              var p = l.toLowerCase()
              if ("null" === p || "nullable" === p) a.isNullable = !0
              else if ("pk" === p)
                a.isUniq &&
                  this.addError(
                    t.line,
                    "The field cannot be a primary key and an unique key, since a primary key is unique"
                  ),
                  a.isIdx &&
                    this.addError(
                      t.line,
                      "The field cannot be a primary key and an index, since a primary key is an index"
                    ),
                  (a.isPk = !0)
              else if ("unique" === p)
                a.isPk &&
                  ...
                  a.isIdx &&
                    this.addError(
                      t.line,
                      "The field cannot be an unique key and an index, since an unique key is an index"
                    ),
                  (a.isUniq = !0)
              else if ("index" === p)
                a.isPk &&
                ...
                var h = l.split("=")
                ;(a.type = h[0]), (a.defaultValue = h[1])
              } else a.type = l
            }
            return a
          }
          this.addError(t.line, "Table field name cannot be empty")
        } else this.addError(t.line, "Table field name cannot be empty")
      }),
      (t.prototype.tokenizeFieldLine = function (e) {
        if (!_.contains(e, '"'))
          return _.map(
            this.splitByWhitespaceAndRemoveEmptyStrings(e),
            function (e) {
              return {
                value: e,
              }
        ...
        for (
          ...
          0 === t
            ...
            ? " " === a
              ? o.length > 0 &&
                (i.push(this.buildTableFieldToken(o, n)), (o = []), (n = []))
              : '"' === a
              ? (t = 2)
              : (o.push(a), n.push(a))
            : 2 === t &&
        ...
        return o.length > 0 && i.push(this.buildTableFieldToken(o, n)), i
      }),
      ...
      (t.prototype.setSectionTableField = function (e, t, i) {
        if (t && 0 !== Object.keys(this.sections.tables).length)
          if (this.sections.tables[e].fields[t.identifier])
            this.addError(
              i,
              "Table field '" + t.identifier + "' already defined"
            )
          else {
            var o = this.sections.tables[e].fields
            ;(t.order = _.size(o)), (o[t.identifier] = t)
          }
      }),
      (t.prototype.isTableFieldsSeparator = function (e) {
        return this.isMadeOfSameCharacters(
          e,
          this.QdbdParserConfig.tableSeparator
        )
      }),
      ...
      (t.prototype.getTable = function (e) {
        return this.isCaseSensitive()
          ? this.sections.tables[e]
          : _.find(this.sections.tables, function (t) {
      ...
      (t.prototype.parseRelationship = function (e) {
        if (this.isRelationshipTypeToken(e.relationType)) {
          ...
          if (t && i) {
            ...
            if (
              (this.resolveAssociationTypes(o, e.relationType),
              this.relationshipAlreadyExists(o))
            )
              return this.sections.relationships.push(o), o
          }
        } else {
          var n = this.allowedRelTypes.join(", ")
          this.addError(
            e.line,
            "Invalid relationship description (allowed: " + n + ")"
          )
        }
      }),
      ...
      (t.prototype.parseRelationshipToken = function (e, t) {
        ...
        } else this.addError(t, "Relationship key cannot be empty")
      }),
      ...
      (t.prototype.resolveAssociationTypes = function (e, t) {
        switch (t) {
          case ">-<":
            ;(e.table1.type = "many"), (e.table2.type = "many")
            break
          case ">-":
            ;(e.table1.type = "many"), (e.table2.type = "one")
            break
          case "-<":
            ;(e.table1.type = "one"), (e.table2.type = "many")
            break
          case "-":
            ;(e.table1.type = "one"), (e.table2.type = "one")
            break
          case "0-":
            ;(e.table1.type = "zeroOne"), (e.table2.type = "one")
            break
          case "-0":
            ;(e.table1.type = "one"), (e.table2.type = "zeroOne")
            break
          case "0-0":
            ;(e.table1.type = "zeroOne"), (e.table2.type = "zeroOne")
            break
          case ">0-":
            ;(e.table1.type = "zeroMany"), (e.table2.type = "one")
            break
          case "-0<":
            ;(e.table1.type = "one"), (e.table2.type = "zeroMany")
        }
      }),
      (t.prototype.relationshipAlreadyExists = function (e) {
        ...
        return (
          i &&
            this.addError(
              e.line,
              "Relationship already defined at line " + i.line
            ),
          !i
        )
      }),
      (t.prototype.getDuplicateRelationship = function (e, t) {
        if (
          (e.table1.tableIdentifier === t.table1.tableIdentifier &&
            e.table1.fieldIdentifier === t.table1.fieldIdentifier &&
            e.table2.tableIdentifier === t.table2.tableIdentifier &&
            e.table2.fieldIdentifier === t.table2.fieldIdentifier) ||
          (e.table1.tableIdentifier === t.table2.tableIdentifier &&
            e.table1.fieldIdentifier === t.table2.fieldIdentifier &&
            e.table2.tableIdentifier === t.table1.tableIdentifier &&
            e.table2.fieldIdentifier === t.table1.fieldIdentifier)
        )
          return e
      }),
      ...
      (t.prototype.validateRelationshipTable = function (e, t) {
        var i = this.getTable(e.tableIdentifier)
        {
          ...
          this.addError(
            t,
            "Invalid relationship, the table '" +
              e.tableIdentifier +
              "' does not exist"
          )
        }
            ...
            if (!(o = this.getTableField(t, e.fieldIdentifier))) {
              if ("qdbdvirtualfield" !== e.fieldIdentifier)
                return void this.addError(
                  i,
                  "Invalid relationship, the field '" +
                    e.tableIdentifier +
                    "." +
                    e.fieldIdentifier +
                    "' does not exist"
                ...
                if (t.sections.layout[n])
                  ...
                  if (t.isNumeric(r)) {
                    ...
                    if (t.isNumeric(s)) {
                      ...
                      t.addError(
                        e.line,
                        "Invalid Y coordinate '" + s + "', number expected"
                      )
                  } else
                    t.addError(
                      e.line,
                      "Invalid X coordinate '" + r + "', number expected"
                    )
                }
              else
                t.addError(
                  e.line,
                  "Invalid layout definition name, the table '" +
                    o +
                    "' does not exist"
                )
            else t.addError(e.line, "Table name cannot be empty")
          } else t.addError(e.line, "Layout definition requires 3 values (tableName, x, y)")
        })
      }),
      (t.prototype.tokenizeLayoutLine = function (e) {
        ...
        for (
          ...
          0 === t
            ...
            : 1 === t &&
              (" " === r
                ? o.length > 0 && (i.push(o.join("")), (o = []))
                : o.push(r))
        }
        return o.length > 0 && i.push(o.join("")), i
      }),
      (t.prototype.splitByWhitespaceAndRemoveEmptyStrings = function (e) {
        return e
          ? _.filter(e.split(" "), function (e) {
              return !!e
            })
          : []
      }),
      (t.prototype.splitAndGroupTokensByWhitespace = function (e) {
        ...
        return (
          _.each(e, function (e) {
            if ("" === e.value) return _.isEmpty(i) || t.push(i), void (i = [])
            i.push(e)
          }),
      ...
      (t.prototype.decimalEncodeText = function (e) {
        ...
        return (
          _.each(e, function (e) {
            t.isAllowedName(e) || (e = t.decimalEncodeCharacter(e)), i.push(e)
          }),
          i.join("")
        )
      }),
  ...
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.createDiagram = function (e) {
        var t = this
        return (
          (e.sharedMetadata && e.sharedMetadata.name) ||
      ...
      (t.prototype.createDiagramInDirWithNamePrompt = function (e) {
        var t = this,
          i = this.$q.defer()
        return (
          this.isUserAllowedToCreateNewDiagram().then(function (o) {
            if (!o.data.isAllowed)
              return (
                t.AccountService.requireSubscription(o.data.message),
                void i.reject()
              )
            var n = t.$mdDialog
              .prompt()
      ...
      (t.prototype.autoSave = function (e) {
        return e && e.shortcode && e.schema
          ? this.$http.post("api/v1/diagram/autoSave", e)
          : this.$q.resolve()
      }),
    ...
    ;(t.$inject = [
      ...
      (t.prototype.flipIsBasicPaletteActive = function () {
        this.SourceEditorService.flipActivePalette(),
          (this.isBasicPaletteActive = this.SourceEditorService.isBasicPaletteActive()),
          this.TrackingService.trackColorPalette(
            this.SourceEditorService.getActivePalette()
          ),
          this.$rootScope.$broadcast("re-render-diagram")
      }),
      (t = __decorate(
        [
          e.Component("QdbdApp.SourceEditor", "dtSourceEditorMenu", {
            templateUrl:
              "cache/modules/source-editor/dt-source-editor-menu.html",
...
!(function (e) {
    ...
    return (
      ...
      (e.prototype.shouldSaveCurrentDiagram = function () {
        ...
        return !t &&
          ...
          !i.shortcode &&
          this.AccountService.isUserLoggedIn() &&
          !this.isDefaultDiagramAndUserAlreadyHasDiagrams(i)
          ? this.SchemaService.isUserAllowedToCreateNewDiagram()
              .then(function (t) {
                return !!t.data.isAllowed || e.disallowCurrentDiagramSaving()
              })
              .catch(this.disallowCurrentDiagramSaving.bind(this))
          : this.$q.resolve(!1)
      }),
      (e.prototype.disallowCurrentDiagramSaving = function () {
        return (
          this.ToastService.showError(
            "Pro account required to save the diagram you just created before logging in"
          ),
          !1
        )
      }),
      (e.prototype.isDefaultDiagramAndUserAlreadyHasDiagrams = function (e) {
        return (
          !!(
            ...
            _.isString(e.schema) &&
            this.$rootScope.currentUser &&
            0 !== this.$rootScope.currentUser.schemaStats.diagramCount
          ) &&
          ("" === e.schema ||
            this.SourceEditorService.isDemoSampleWithoutMeta(e.schema))
        )
      }),
      (e.prototype.saveCurrentDiagram = function () {
        ...
        this.DialogService.showDialogNotification(
          0 === this.$rootScope.currentUser.schemaStats.diagramCount
            ...
            : "Please wait while we save your new diagram."
        ),
          this.SchemaFirebaseService.signIn()
            .then(function () {
              return e.SchemaService.createDiagram(
                e.AppStateService.getCurrentDiagram()
              )
            })
            .then(function (t) {
      ...
      (e.prototype.initializeDirective = function () {
        ...
        if (
          ...
          this.AccountService.isUserLoggedIn()
            ? this.goToFirstDirTreeItemOrLoadDefaultDiagram()
      ...
      (e.prototype.registerEventHandlers = function () {
        ...
        this.registerMenuActionListener(),
          this.$scope.$on(
            "diagram-writable-changed",
            this.onDiagramWritableChanged.bind(this)
          ),
          this.$scope.$on("diagram-dragged", this.onDiagramDragged.bind(this)),
          this.$scope.$on(
            "diagram-table-row-clicked",
            this.onDiagramTableRowClicked.bind(this)
          ),
          this.$scope.$on(
            "diagram-table-moved",
            this.onDiagramTableMoved.bind(this)
          ),
          this.$scope.$on(
            "diagram-ports-connected",
            this.onDiagramPortsConnected.bind(this)
          ),
          this.$scope.$on(
            "diagram-link-removed",
            this.onDiagramLinkRemoved.bind(this)
          ),
          this.$scope.$on("center-diagram", this.centerDiagram.bind(this)),
          this.$scope.$on("diagram-zoom-set", this.onDiagramZoomSet.bind(this)),
          this.$scope.$on(
            "diagram-viewport-set",
            this.onDiagramViewportSet.bind(this)
          ),
          this.$scope.$on("re-render-diagram", function () {
            return e.rerenderCurrentSchema(!0)
          }),
          this.$scope.$on(
            "unload-editor-diagram",
            this.unloadDiagram.bind(this)
          ),
        ...
        t &&
          ...
          this.SchemaFirebaseService.signIn()
            ...
            .then(function () {
              ...
              ;(e.firebaseRefs.firepad = e.SchemaFirebaseService.editorFactory(
                e.aceEditor,
                e.diagram.shortcode
              )),
      ...
      (e.prototype.intializeFirebaseEventHandlers = function () {
        ...
        ;(this.firebaseRefs.sharedMetadata = this.SchemaFirebaseService.registerSharedMetadataListener(
          e,
          this.onSharedMetadataHandler.bind(this)
        )),
          (this.firebaseRefs.layout = this.SchemaFirebaseService.registerLayoutListener(
            e,
            this.onLayoutHandler.bind(this)
          )),
          (this.firebaseRefs.viewport = this.SchemaFirebaseService.registerViewportListener(
            e,
            this.onViewportHandler.bind(this)
          ))
      }),
      (e.prototype.onSharedMetadataHandler = function (e, t) {
        e ||
          _.isEqual(this.diagram.sharedMetadata, t) ||
          ((this.diagram.sharedMetadata = t), this.initializeRenderingStage1())
      }),
      (e.prototype.onLayoutHandler = function (e, t) {
        e ||
          _.isEqual(this.diagram.layout, t) ||
          ((this.diagram.layout = t), this.initializeRenderingStage1())
      }),
      (e.prototype.onViewportHandler = function (e, t) {
        e ||
          _.isEqual(this.diagram.viewport, t) ||
          ((this.diagram.viewport = t), this.initializeRenderingStage1())
      }),
      (e.prototype.initializeRenderingStage1 = function () {
        if (this.diagram) {
          ...
          return e
            ? ".." === e
              ? (this.demo(), void (this.isRenderingInitialized = !1))
              : void (
                  (this.isMetadataConversionInProgress &&
                    this.SourceEditorService.schemaContainsMetadata(e)) ||
                  ((this.isMetadataConversionInProgress = !1),
                  (this.diagram.schema = e),
                  (this.qdbdSchema = this.SchemaParserService.parseSource(
                    e,
                    this.diagram.sharedMetadata,
                    this.diagramSecurity
                  )),
                  this.SourceEditorService.schemaErrorsExist(this.qdbdSchema)
                    ? this.handleSchemaErrors(this.diagram, this.qdbdSchema)
                    : (this.setPageTitle(),
                      this.initializeRenderingStage2(
                        this.diagram,
                        this.diagramSecurity,
                        this.qdbdSchema
                      )))
      ...
      (e.prototype.onMetadataConversion = function (e) {
        this.AccountService.isUserLoggedIn() &&
          ((this.isMetadataConversionInProgress = !0),
      ...
      (e.prototype.cancelInitializedRendering = function () {
        this.broadcastRenderPromise &&
          (this.$timeout.cancel(this.broadcastRenderPromise),
          (this.isRenderingInitialized = !1),
      ...
      (e.prototype.initializeServerDiagram = function () {
        var e = this,
          t = this.getUrlShortcode()
        t.length > 6
          ? this.resolveShorterShortcodeRoute(t)
          : this.resolveDiagramSecurity().then(function (t) {
              _.isEmpty(t)
                ? (e.ToastService.showError("Diagram does not exist."),
                  e.AccountService.isUserLoggedIn() ||
                    (e.SourceEditorService.clearLocalShortcode(),
                    e.$state.go("root.standardShrinkable.home")))
                : e.intializeFirePad()
      ...
      (e.prototype.resolveShorterShortcodeRoute = function (e) {
        ...
        this.SchemaService.getShortcode(e).then(function (e) {
          e.data
            ? t.$state.go("root.standardShrinkable.diagram", {
                shortcode: e.data,
              })
      ...
      (e.prototype.resolveDiagramSecurity = function () {
        var e = this
        return this.SchemaService.getDiagramSecurity(
          this.diagram.shortcode
        ).then(function (t) {
      ...
      (e.prototype.loadCurrentDiagram = function () {
        this.loadSchema(this.diagram.schema),
          this.AccountService.isUserLoggedIn() &&
            !this.$rootScope.currentUser.hasProAccess &&
            this.$rootScope.currentUser.schemaStats.diagramCount > 0 &&
            this.aceEditor.setReadOnly(!0)
      }),
      ...
      (e.prototype.loadDefaultDiagram = function () {
        this.SourceEditorService.isDemoInitialized()
          ? this.loadSchema("")
          : (this.loadDemoSchema(),
      ...
      (e.prototype.onDiagramDragged = function (e, t) {
        ...
        this.delayInteraction(function () {
          i.SourceEditorService.setViewportPosition(i.diagram, t.x, t.y),
            i.SchemaFirebaseService.setDiagramViewport(
              i.diagram.shortcode,
              i.diagram.viewport
            )
        })
      ...
      (e.prototype.onDiagramTableMoved = function (e, t, i) {
        var o = this
        this.delayInteraction(function () {
          o.SourceEditorService.purgeParentlessLayoutTables(
            o.diagram,
            o.qdbdSchema
          ),
          ...
          o.SourceEditorService.updateTablePosition(o.diagram, i, e),
            o.SchemaFirebaseService.setDiagramLayoutTable(
              o.diagram.shortcode,
              i,
              e
            )
      ...
      (e.prototype.onDiagramPortsConnected = function (e, t) {
        var i = this
        this.diagramSecurity && this.diagramSecurity.isLockedForEditing
          ? this.ToastService.showInfo("This diagram is in read-only mode.")
          : this.delayInteraction(function () {
      ...
      (e.prototype.centerDiagram = function (e, t) {
        this.SourceEditorService.setViewportPosition(this.diagram, 0, 0),
          ...
          this.SchemaFirebaseService.setDiagramViewport(
            this.diagram.shortcode,
            this.diagram.viewport
          )
      }),
      ...
      (e.prototype.rename = function () {
        var e = this,
          t = this.$mdDialog
            ...
            .placeholder("New Name")
            .ariaLabel("New File Name")
            .initialValue(this.diagram.sharedMetadata.name)
            .ok("Ok")
            .cancel("Cancel")
            .clickOutsideToClose(!0)
        this.$mdDialog.show(t).then(function (t) {
          t
            ? (e.SchemaService.renameDiagram({
                name: t,
                shortcode: e.diagram.shortcode,
              }),
              e.broadcastDiagramChanged(e.diagram, e.qdbdSchema))
            : e.ToastService.showWarning("Empty names not allowed")
        })
      }),
      (e.prototype.copyCurrentDiagram = function () {
        var e = this
        this.AccountService.requireLogin() ||
          this.AccountService.requireSubscription() ||
          this.SchemaService.createDiagram(this.diagram).then(function (t) {
      ...
      (e.prototype.share = function () {
        this.AccountService.requireLogin() ||
          (this.TrackingService.trackShare("LINK"),
      ...
      (e.prototype.flipPrivate = function () {
        ...
        if (!this.AccountService.requireSubscription()) {
          var t = this.$mdDialog
            .confirm()
            .title(
              this.diagramSecurity.isPrivate ? "Make public" : "Make private"
            )
            .htmlContent(
              "<p>Are you sure you want to change the privacy of the diagram?</p>"
            )
            .ok("Yes")
            .cancel("No")
            .clickOutsideToClose(!0)
          this.$mdDialog.show(t).then(function () {
            e.SchemaService.flipDiagramPrivacy(e.diagram.shortcode)
              .then(function () {
      ...
      (e.prototype.undo = function () {
        this.aceEditor.undo(), this.aceEditor.gotoLine(0, 0)
      }),
      (e.prototype.redo = function () {
        this.aceEditor.redo(), this.aceEditor.gotoLine(0, 0)
      }),
      (e.prototype.cut = function () {
        this.copy(), this.aceEditor.insert("")
      }),
      (e.prototype.copy = function () {
        this.aceEditor.selection.toJSON()
        this.aceEditor.focus(), document.execCommand("copy")
      }),
      (e.prototype.exportToSQL = function (e) {
        this.SchemaExportService.exportToSQL(
          this.diagram.shortcode,
          this.qdbdSchema,
          e,
          this.getSchemaUrl(),
      ...
      (e.prototype.exportToDoc = function (e) {
        this.SchemaExportService.exportToDoc(
          this.diagram.shortcode,
          this.qdbdSchema,
          e,
          this.getSchemaUrl(),
      ...
      (e.prototype.exportToSVG = function () {
        0 !== Object.keys(this.qdbdSchema.errors).length
          ? this.ToastService.showError(
              "Schema contains errors and cannot be exported."
            )
          : this.DiagramExportService.exportToSVG(this.diagram, this.qdbdSchema)
      }),
      (e.prototype.exportToPNG = function () {
        0 !== Object.keys(this.qdbdSchema.errors).length
          ...
          : this.DiagramExportService.exportToPNG(this.diagram, this.qdbdSchema)
      }),
      ...
      (e.prototype.setFieldType = function () {
        var e = this,
          t = this.$mdDialog
            .prompt()
            .title("Enter default field type")
            .placeholder("Field Type")
            .ariaLabel("New Field Type")
            .initialValue(this.getDefaultFieldType())
            .ok("Ok")
            .cancel("Cancel")
            .clickOutsideToClose(!0)
        this.$mdDialog.show(t).then(function (t) {
          e.SourceEditorService.ensureSharedMetadataExists(e.diagram),
            ...
            e.SchemaFirebaseService.setDiagramSharedMetadata(
              e.diagram.shortcode,
              e.diagram.sharedMetadata
            ),
            e.rerenderCurrentSchema(!0)
        })
      }),
      (e.prototype.flipCasing = function () {
        this.SourceEditorService.ensureSharedMetadataExists(this.diagram),
          (this.diagram.sharedMetadata.isCaseSensitive = !this.diagram
            .sharedMetadata.isCaseSensitive),
          this.SchemaFirebaseService.setDiagramSharedMetadata(
            this.diagram.shortcode,
            this.diagram.sharedMetadata
          ),
      ...
      (e.prototype.getDefaultFieldType = function () {
        return this.diagram && this.diagram.sharedMetadata
          ? this.diagram.sharedMetadata.defaultType || "int"
          : "int"
      }),
      ...
      (e.prototype.getTableCount = function () {
        return this.aceEditor.getValue() &&
          this.qdbdSchema &&
          this.qdbdSchema.sections
          ? _.size(this.qdbdSchema.sections.tables)
          : 0
      }),
      ...
      (e.prototype.delayInteraction = function (e, t) {
        this.interactionTimeout &&
          this.$timeout.cancel(this.interactionTimeout),
      ...
      (e.prototype.getParsingStatus = function () {
        return (
          this.broadcastRenderPromise &&
          0 === this.broadcastRenderPromise.$$state.status &&
          !this.updateCausedByInteraction
            ? (this.parsingStatus = "loading")
            : this.SourceEditorService.schemaErrorsExist(this.qdbdSchema)
      ...
      (e.prototype.getSchemaName = function () {
        return this.diagram &&
          this.diagram.sharedMetadata &&
          this.diagram.sharedMetadata.name
          ? this.diagram.sharedMetadata.name
          : void 0
      }),
      ...
      (e.prototype.showReadOnlyMessage = function () {
        return (
          this.diagramSecurity &&
          this.AccountService.isUserLoggedIn() &&
          this.diagramSecurity.isLockedForEditing &&
          !this.diagramSecurity.isOwnedByCurrentUser
        )
      }),
      (e.prototype.setPageTitle = function () {
        if (this.diagram && this.diagram.shortcode) {
          var e =
            (this.diagram.sharedMetadata
              ? this.diagram.sharedMetadata.name
              : void 0) || this.SchemaService.getNewFileName()
          e && (e += " - "), (this.$rootScope.pageTitle = e + "QuickDBD")
        } else this.$rootScope.pageTitle = "QuickDBD"
      }),
      ...
      (e.prototype.autoSave = function (e) {
        this.lastAutoSaveAt
          ? this.lastAutoSaveAt.isAfter(moment().add(-1, "minutes")) ||
            ((this.lastAutoSaveAt = moment()),
      ...
      (e.prototype.profitWellTrack = function () {
        this.lastProfitWellAt
          ? this.lastProfitWellAt.isAfter(moment().add(-1, "hours")) ||
            ((this.lastProfitWellAt = moment()),
            this.TrackingService.profitWellTrack())
          : (this.lastProfitWellAt = moment())
      }),
  ...
  angular
    .module("QdbdApp.SourceEditor")
    .controller("DtSourceEditorCtrl", t)
    .directive("dtSourceEditor", function () {
      return {
        restrict: "E",
  ...
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.setViewport = function (e, t) {
        this.ensureViewportExists(e), _.extend(e.viewport, t)
      }),
      ...
      (t.prototype.resolveZoomLevel = function (e, t) {
        this.ensureViewportExists(e), (e.viewport.zoom = this.validateZoom(t))
      }),
      ...
      (t.prototype.addRelationshipToLine = function (e, t) {
        if (t.fromLine === t.toLine) return e
        if (this.SchemaParserService.isValidLine(parseInt(t.fromLine)))
          return (
            this.ToastService.showError(
              "Could not create relationship, found error on line " +
                t.fromLine +
                "."
            ),
            e
        ...
        var i =
            "FK >- " +
            this.createRelDefinitionSegment(t.toTable) +
            "." +
            this.createRelDefinitionSegment(t.toField),
      ...
      (t.prototype.removeRelationshipFromLine = function (e, t) {
        if (this.SchemaParserService.isValidLine(t))
          return (
            this.ToastService.showError(
              "Could not create relationship, found error on line " + t + "."
            ),
            e
          )
      ...
      (t.prototype.applySchemaMetadataConversion = function (e, t) {
        var i = this
        if (!e || !t) return !1
        if (!this.schemaContainsMetadata(e.schema)) return !1
      ...
      (t.prototype.purgeParentlessLayoutTables = function (e, t) {
        if (t && t.sections) {
          ...
          o.length > 0 &&
            this.SchemaFirebaseService.removeDiagramLayoutTables(e.shortcode, o)
        }
      }),
      ...
      (t.prototype.metadataConversionNotification = function (e) {
        var t = this
        this.isDemoSampleWithoutMeta(e.schema) ||
          (this.localStorageService.get(this.CONVERSION_NOTIFICATION_KEY)
            ? this.ToastService.showInfoWithAction(
                "Diagram format updated",
                "INFO",
                function () {
            ...
            : (this.localStorageService.set(
                this.CONVERSION_NOTIFICATION_KEY,
                !0
              ),
      ...
      (t.prototype.showMetadataConversionModal = function () {
        var e = this.$mdDialog
          .alert()
          .title("Notification - Diagram format updated")
          .htmlContent(
            "Due to a system upgrade, the [Settings] and [Layout] sections are no longer<br/>visible. This information is now stored in the background. Your diagram has<br/>been automatically converted to the new format."
          )
          .ok("Ok")
          .clickOutsideToClose(!0)
      ...
      (t = __decorate(
        [e.Service("QdbdApp.SourceEditor", "SourceEditorService")],
        t
      ))
    )
  })()
    ...
    ;(t.$inject = [
      ...
      (t.prototype.initialize = function () {
        ...
        ;(this.billingDetails = e),
          this.billingDetails
            ? (this.editForm =
                !this.billingDetails.firstName || !this.billingDetails.lastName)
            : this.$state.go("root.standardShrinkable.home")
      }),
      (t.prototype.confirmEmail = function () {
        var e = this
      ...
      (t.prototype.confirmBillingDetails = function () {
        var e = this
        this.SubscriptionService.updateBillingDetails(this.billingDetails).then(
          function () {
            e.SubscriptionService.cacheVoucherCodeChoice(
              e.billingDetails.voucherCode
            ),
      ...
      (t.prototype.back = function () {
        !this.$rootScope.currentUser.hasProAccess &&
        this.SubscriptionService.hasVoucherCode()
          ? this.$state.go("root.standardShrinkable.home")
          : this.$state.go("root.centered.subscribe")
      }),
      (t = __decorate(
        [e.Controller("QdbdApp.Subscription", "BillingDetailsCtrl")],
        t
      ))
  })()
})(QdbdApp || (QdbdApp = {}))
...
!(function (e) {
  !(function () {
    ...
    ;(t.$inject = [
      ...
      (t.prototype.initialize = function () {
        var e = this
        this.SubscriptionService.getCheckoutDetails()
          .then(function (t) {
            return (
              (e.checkoutDetails = t.data),
          ...
          .then(
            ...
            function (t) {
              t.data.modelState["model.DiscountCode"] &&
              t.data.modelState["model.DiscountCode"].length > 0
                ? (e.SubscriptionService.clearDiscountCached(),
                  e.ToastService.showError(
                    t.data.modelState["model.DiscountCode"][0]
                  ),
                  e.back())
                : e.showErrorToast()
            }
      ...
      (t.prototype.teardown = function () {
        ...
        this.$timeout(function () {
          e.dropInInstance &&
            e.dropInInstance.teardown(function () {
      ...
      (t.prototype.initializeDropin = function (e) {
        ...
        ;(this.braintreeInitStarted = !0),
          "voucher" !== this.checkoutDetails.plan &&
            braintree.dropin.create(
              ...
              function (e, i) {
                t.$timeout(function () {
                  e
                    ? (t.ErrorService.logError(e), t.showErrorToast())
                    : t.initializeDropinInstance(i)
                })
              }
            )
      }),
          ...
          this.dropInInstance.on("paymentMethodRequestable", function (e) {
            t.$timeout(function () {
              ;(t.isMethodSelectable = t.isPaymentMethodSelectable(e)),
                t.isMethodSelectable
                  ? (t.isMethodSelected = !1)
                  : (t.isMethodSelected = !!t.getActivePaymentMethod())
            })
          }),
          this.dropInInstance.on("noPaymentMethodRequestable", function () {
            t.$timeout(function () {
              ;(t.isMethodSelectable = !1), (t.isMethodSelected = !1)
            })
          }),
      ...
      (t.prototype.getActivePaymentMethod = function () {
        if (
          this.dropInInstance &&
          this.dropInInstance._model &&
          this.dropInInstance._model._activePaymentMethod
        )
      ...
      (t.prototype.selectPaymentMethod = function () {
        ...
        this.dropInInstance.requestPaymentMethod(function (t, i) {
          e.$timeout(function () {
            t
              ? (e.ErrorService.logError(t), e.showErrorToast())
              : ((e.isMethodSelectable = !1),
      ...
      (t.prototype.authorizePayment = function () {
        var e = this,
          t = {}
        if (this.isVoucher) t.voucherCode = this.checkoutDetails.voucherCode
        else {
          var i = this.getActivePaymentMethod()
          if (!i || !i.nonce) return void this.showErrorToast()
          t.nonce = i.nonce
        }
        ;(t.discountCode = this.SubscriptionService.getCachedDiscountCodeChoice()),
          (this.authorizationInProgress = !0),
          this.SubscriptionService.subscribe(t).then(
            function () {
              e.TrackingService.trackPurchase(
                e.checkoutDetails.amountToPay,
                e.checkoutDetails.planCaption.split(" ")[0]
              ),
                e.MessageScreenService.showSuccess({
                  header: "Payment successful!",
                  message:
                    "Thank you! You have successfuly subscribed to QuickDBD.",
                })
            },
            function () {
      ...
      (t.prototype.showErrorContactUsPage = function () {
        this.MessageScreenService.showError({
          ...
          message:
            "Sorry, something went wrong during the payment process. Please contact us at info@dovetail.ie and we'll sort it out for you.",
        })
      }),
      (t.prototype.back = function () {
      ...
      (t = __decorate(
        [e.Controller("QdbdApp.Subscription", "CheckoutCtrl")],
        t
      ))
  })()
})(QdbdApp || (QdbdApp = {}))
    ...
    ;(t.$inject = [
      ...
      (t.prototype.confirm = function () {
        ...
        ;(this.model.reason = this.reasons[this.model.reasonId].reason),
          this.SubscriptionService.cancelSubscription(this.model).then(
            function () {
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.Subscription", "dtCancelSubscription", {
            bindings: {
              userId: "@",
            },
            templateUrl:
              "cache/modules/subscription/dt-cancel-subscription/dt-cancel-subscription.html",
  ...
  !(function () {
    function t(e, t, i, o, n, r) {
      ...
      ;(this.$rootScope = e),
        ...
        this.$state.current.url.toString().indexOf("voucher") >= 0
          ? this.parseVoucherURL()
          : this.$state.current.url.toString().indexOf("discount") >= 0
          ? this.parseDiscountURL()
          : this.AccountService.reAuthenticate().then(function () {
              a.SubscriptionService.ensureUserNotSubscribed(),
                !a.$rootScope.currentUser.hasProAccess &&
                  a.SubscriptionService.hasVoucherCode() &&
                  a.selectSubscription("voucher")
            })
    }
    ;(t.$inject = [
      "$rootScope",
      ...
      (t.prototype.parseDiscountURL = function () {
        var e = this
        this.$state.params &&
          this.$state.params.discountCode &&
          (this.SubscriptionService.cacheDiscountCodeChoice(
            this.$state.params.discountCode
          ),
          this.SubscriptionService.getDiscount().then(function (t) {
            t.data <= 0
              ? (e.MessageScreenService.showError({
                  header: "Discount code not found!",
                  message:
                    "Sorry, the discount code <b>" +
                    e.SubscriptionService.getCachedDiscountCodeChoice() +
                    "</b> was not found, please contact the system administrator",
                }),
                e.SubscriptionService.clearDiscountCached())
              : (e.MessageScreenService.showSuccess({
                  header: "Discount code redeemed!",
                  message:
                    "Your discount code <b>" +
                    e.$state.params.discountCode +
                    "</b> is valid. To activate your discount code go pro now!",
      ...
      (t.prototype.parseVoucherURL = function () {
        if (this.$state.params && this.$state.params.voucherCode) {
          this.SubscriptionService.cacheVoucherCodeChoice(
            this.$state.params.voucherCode
          )
          var e =
            "Thanks for using voucher <b>" +
            this.$state.params.voucherCode +
            "</b>. We've made a record of it. When you upgrade to Pro you will be able to redeem the voucher instead of entering payment details. For now, just carry on using QuickDBD."
          this.MessageScreenService.showSuccess({
      ...
      (t.prototype.redirectIfNotLoggedIn = function () {
        this.AccountService.isUserLoggedIn() ||
          this.$state.go("root.centered.login")
      }),
      ...
      (t.prototype.tweet = function () {
        this.SharingService.tweet(
          "@Quick_DBD is giving away free Pro Plans!! Awesome online tool to design databases online. I love it! TWITTER_LOVE_EMOJI "
        )
      }),
      (t = __decorate(
        [e.Controller("QdbdApp.Subscription", "SubscribeCtrl")],
        t
      ))
  })()
})(QdbdApp || (QdbdApp = {}))
  ...
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.ensureUserNotSubscribed = function () {
        this.$rootScope.currentUser &&
          this.$rootScope.currentUser.activeSubscription &&
          this.MessageScreenService.showError({
      ...
      (t.prototype.clearDiscountCached = function () {
        this.cacheDiscountCodeChoice(""), this.cacheDiscountedValue("")
      }),
      ...
      (t.prototype.getCheckoutDetails = function () {
        ...
        return (
          (null !== t && void 0 !== t && "" !== t) || (t = e),
          (null !== i && void 0 !== i && "" !== i) || (i = e),
          this.$http.get(
            "api/v1/payment/checkoutDetails/" + e + "/" + t + "/" + i
          )
        )
      }),
      ...
      (t.prototype.getDiscount = function () {
        return this.$http.get(
          "api/v1/payment/getDiscountedValue/" +
            this.getCachedDiscountCodeChoice(),
          null
        )
      }),
      ...
      (t = __decorate(
        [e.Service("QdbdApp.Subscription", "SubscriptionService")],
        t
      ))
    )
  })()
    ...
    ;(t.$inject = ["$scope", "SchemaService", "PagingService"]),
      (t.prototype.$onInit = function () {
        ;(this.pager = this.PagingService.pagerFactory(
          this.filter,
          this.diagrams,
          this.getUserDiagrams.bind(this),
          "root.standard.user.diagrams"
        )),
          this.$scope.$watch(
            "DtUserDiagramsVM.filter",
            this.pager.onFilterChanged.bind(this),
            !0
          )
      }),
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.SourceEditor", "dtUserDiagrams", {
            bindings: {
              filter: "=",
            },
            templateUrl:
              "cache/modules/user/dt-user-diagrams/dt-user-diagrams.html",
...
!(function (e) {
  !(function () {
    ...
    ;(t.$inject = ["$scope", "UserService", "ToastService", "PagingService"]),
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.User", "dtUserList", {
            bindings: {
              filter: "=",
            },
  ...
  !(function () {
    ...
    ;(t.$inject = ["SubscriptionService"]),
      ...
      (t.prototype.getUserPayments = function () {
        var e = this
        this.SubscriptionService.getUserPayments(this.userId).then(function (
          t
        ) {
          e.payments = t.data
        })
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.User", "dtUserPayments", {
            bindings: {
              userId: "=",
            },
            templateUrl:
              "cache/modules/user/dt-user-payments/dt-user-payments.html",
    ...
    ;(t.$inject = [
      ...
      (t.prototype.grantProAccess = function (e) {
        var t = this,
          i = this.$mdDialog
            ...
            .htmlContent("Are you sure you want to give this user pro access?")
            .ok("Yes")
            .cancel("No")
            .clickOutsideToClose(!0)
        this.$mdDialog.show(i).then(function () {
          t.SubscriptionService.grantProAccess(t.userProfile.userId, e).then(
            function () {
              t.ToastService.showInfo("Pro access granted"),
                t.initializeUser && t.initializeUser(),
                t.AccountService.reAuthenticateIfCurrentUser(
      ...
      (t.prototype.removeSubscription = function () {
        var e = this,
          t = this.$mdDialog
            ...
            .htmlContent(
              "Are you sure you want to remove this user's subscription?"
            )
            .ok("Yes")
            .cancel("No")
            .clickOutsideToClose(!0)
        this.$mdDialog.show(t).then(function () {
          e.SubscriptionService.removeSubscription(e.userProfile.userId).then(
            function () {
              e.ToastService.showInfo("Subscription removed"),
                e.initializeUser && e.initializeUser(),
                e.AccountService.reAuthenticateIfCurrentUser(
      ...
      (t.prototype.flipCollab = function (e) {
        var t = this,
          i = this.$mdDialog
            .confirm()
            .title("Collab status change")
            .htmlContent(
              "Are you sure you want to change the collab status for this user?"
            )
            .ok("Yes")
            .cancel("No")
            .clickOutsideToClose(!0)
        this.$mdDialog.show(i).then(function () {
          t.UserService.flipCollab(e).then(function () {
            t.initializeUser(), t.ToastService.showInfo("Collab status changed")
          })
        })
      }),
      (t.prototype.deleteUser = function (e) {
        var t = this,
          i = this.$mdDialog
            ...
            .htmlContent(
              "This is a destructive action. Your account will be removed and you will no longer have access to it. <br /><br />All diagrams associated with this account will be lost. This operation is irreversible. <br /><br />Are you sure you want to proceed? "
            )
        ...
        this.$mdDialog.show(i).then(function () {
          t.UserService.deleteUser(e).then(function () {
            t.ToastService.showInfo("Account Deleted"),
              t.$rootScope.currentUser.userId === e
                ? t.AccountService.logout()
                : t.$state.go("root.standard.admin.userList")
          })
        })
      }),
      (t = __decorate(
        [
          e.Component("QdbdApp.User", "dtUserProfile", {
            bindings: {
              userProfile: "=",
              initializeUser: "&",
            },
            templateUrl:
              "cache/modules/user/dt-user-profile/dt-user-profile.html",
  ...
  !(function () {
    ...
    ;(t.$inject = ["$scope", "$state", "UserService"]),
      (t.prototype.initializeUser = function () {
        ...
        e
          ? this.UserService.getUserProfile(e).then(
              this.onProfileFetched.bind(this),
              this.onProfileFetchError.bind(this)
            )
          : this.UserService.getCurrentUserProfile().then(
              this.onProfileFetched.bind(this),
              this.onProfileFetchError.bind(this)
            )
      }),
...
!(function (e) {
  !(function () {
    ...
    ;(t.$inject = ["$rootScope", "$state", "$timeout", "TrackingService"]),
      ...
      (t.prototype.handleRouting = function () {
        this.$state.is("root.standard.user") &&
          this.$state.go("root.standard.user.profile", {
            userId: this.$rootScope.currentUser.userId,
          })
      }),
      (t.prototype.initializeFilter = function () {
    ...
    ;(t.$inject = [
      ...
      (t.prototype.$onInit = function () {
        ;(this.pager = this.PagingService.pagerFactory(
          this.filter,
          this.vouchers,
          this.loadVouchers.bind(this),
          "root.standard.admin.vouchersList"
        )),
          this.$scope.$watch(
            "DtVoucherListVM.filter",
            this.pager.onFilterChanged.bind(this),
            !0
          )
      }),
      ...
      (t = __decorate(
        [
          e.Component("QdbdApp.Voucher", "dtVoucherList", {
            bindings: {
              filter: "=",
            },
            templateUrl:
              "cache/modules/voucher/dt-voucher-list/dt-voucher-list.html",
    ...
    function t(e, t, i, o) {
      ...
      null === n
        ? ((this.voucher.maxRedemptions = 1),
          ...
          (this.isEdit = !1))
        : ((this.voucher = n),
          (this.voucher.validFrom = this.voucher.validFrom
            ? new Date(this.voucher.validFrom.toString())
            : this.voucher.validFrom),
          (this.voucher.validTo = this.voucher.validTo
            ? new Date(this.voucher.validTo.toString())
            : this.voucher.validTo),
          this.voucher.validFrom && this.voucher.validFrom.setHours(0, 0, 0, 0),
          this.voucher.validTo && this.voucher.validTo.setHours(0, 0, 0, 0),
          (this.voucher.minDate = this.voucher.validFrom
            ? _.min([this.voucher.validFrom, new Date()])
            : new Date()),
          (this.isEdit = !0))
    }
    ;(t.$inject = ["$state", "$scope", "VoucherService", "ToastService"]),
      ...
      (t.prototype.save = function () {
        ...
        this.VoucherService.save(this.voucher).then(
          function () {
            e.ToastService.showInfo("Voucher saved successfully."), e.back()
          },
          function (t) {
            ;(e.voucher.modelState = t.data.modelState),
              t.data &&
                t.data.error_description &&
                ((e.voucher.modelState = {}),
      ...
      (t.prototype.setDefaultPeriod = function (e) {
        switch (e) {
          ...
          default:
            ;(this.voucher.validFrom = new Date()),
              (this.voucher.validTo = new Date()),
              this.voucher.validTo.setFullYear(
                this.voucher.validTo.getFullYear() + 1
              )
        }
        this.voucher.validFrom.setHours(0, 0, 0, 0),
...
!(function (e) {
  var t = (function () {
    ...
    return (
      (t.$inject = ["$http", "ToastService", "$window", "$location"]),
      ...
      (t.prototype.copyVoucherUrl = function (e) {
        ...
        try {
          var o =
            this.$location
              .absUrl()
              .substr(0, this.$location.absUrl().indexOf("#") + 1) +
            "/voucher/" +
            e.code
          i.val(o),
            t.append(i),
  ...
  angular.module("QdbdApp.Common").run([
    ...
    function (e) {
      e.put(
        ...
        e.put(
          "cache/modules/collaborators/dt-collaborators.html",
        ...
        e.put(
          "cache/modules/user/dt-user-list/dt-user-list.html",
